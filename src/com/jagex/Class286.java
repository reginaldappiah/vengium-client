package com.jagex;/* Class286 - Decompiled by JODE
...
public class Class286 {
	...
	final void method2715(Buffer class298_sub53, Class279 class279) {
		int i = class298_sub53.readUByte();
		this.anIntArray3088[0] = i >> 4;
		this.anIntArray3088[1] = i & 0xf;
		if (i != 0) {
			this.anIntArray3086[0] = class298_sub53.readUShort();
			this.anIntArray3086[1] = class298_sub53.readUShort();
			int i_0_ = class298_sub53.readUByte();
			for (int i_1_ = 0; i_1_ < 2; i_1_++) {
				for (int i_2_ = 0; i_2_ < this.anIntArray3088[i_1_]; i_2_++) {
					this.anIntArrayArrayArray3084[i_1_][0][i_2_] = class298_sub53.readUShort();
					this.anIntArrayArrayArray3091[i_1_][0][i_2_] = class298_sub53.readUShort();
				}
			}
			for (int i_3_ = 0; i_3_ < 2; i_3_++) {
				for (int i_4_ = 0; i_4_ < this.anIntArray3088[i_3_]; i_4_++) {
					if ((i_0_ & 1 << i_3_ * 4 << i_4_) != 0) {
						this.anIntArrayArrayArray3084[i_3_][1][i_4_] = class298_sub53.readUShort();
						this.anIntArrayArrayArray3091[i_3_][1][i_4_] = class298_sub53.readUShort();
					} else {
	...
	int method2716(int i, float f) {
		if (i == 0) {
			float f_5_ = ((float) this.anIntArray3086[0] + (float) (this.anIntArray3086[1] - this.anIntArray3086[0]) * f);
			f_5_ *= 0.0030517578F;
	...
	float method2717(int i, int i_13_, float f) {
		float f_14_ = ((float) this.anIntArrayArrayArray3084[i][0][i_13_] + f * (float) ((this.anIntArrayArrayArray3084[i][1][i_13_]) - (this.anIntArrayArrayArray3084[i][0][i_13_])));
		f_14_ *= 1.2207031E-4F;
	...
	float method2719(int i, int i_16_, float f) {
		float f_17_ = ((float) this.anIntArrayArrayArray3091[i][0][i_16_] + f * (float) ((this.anIntArrayArrayArray3091[i][1][i_16_]) - (this.anIntArrayArrayArray3091[i][0][i_16_])));
		f_17_ *= 0.0015258789F;
