package com.jagex;/* Class298_Sub32_Sub11_Sub1 - Decompiled by JODE
...
public class Class298_Sub32_Sub11_Sub1 extends Class298_Sub32_Sub11 {
	...
	int[][] method3132(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("akg.k(").append(')').toString());
		}
	}
