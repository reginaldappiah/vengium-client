package com.jagex;/* Class82_Sub1 - Decompiled by JODE
...
public class Class82_Sub1 extends Class82 {
	...
	public void method866() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("xb.f(").append(')').toString());
		}
	}

	Class82_Sub1(Buffer class298_sub53) {
		super(class298_sub53);
		this.anInt6816 = class298_sub53.readUShort() * -1614214389;
	}
	...
	public static void method877(int i, int i_0_, int i_1_, int i_2_, int i_3_) {
		try {
			if (i_1_ == i_2_)
				...
				StaticMethods.method1153(i, i_0_, i_1_, i_2_, i_3_, -735376708);
			else
				Class296.method2834(i, i_0_, i_1_, i_2_, i_3_, 655524402);
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("xb.ao(").append(')').toString());
		}
	}
}
