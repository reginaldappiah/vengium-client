package com.jagex;/* Class298_Sub32_Sub33 - Decompiled by JODE
...
public class Class298_Sub32_Sub33 extends Class298_Sub32 {
	...
	void method3346(int i, Buffer class298_sub53) {
		switch (i) {
		case 6:
			this.anInt9531 = class298_sub53.readUByte() * 1663137711;
			break;
		case 7:
			this.anInt9532 = class298_sub53.readUShort() * 741927281;
			break;
		case 1:
			this.anInt9526 = class298_sub53.readUShort() * -8002361;
			break;
		case 0:
			this.anInt9525 = class298_sub53.readUByte() * -653192821;
			break;
		case 4:
			this.anInt9519 = class298_sub53.readUShort() * 1340421019;
			break;
		case 3:
			this.anInt9528 = class298_sub53.readUShort() * -2128158391;
			break;
		case 5:
			this.anInt9530 = class298_sub53.readUShort() * -420846851;
			break;
		case 2:
			this.anInt9523 = class298_sub53.readUShort() * 334398233;
			break;
		case 8:
			this.anInt9533 = class298_sub53.readUShort() * 1393727635;
			break;
		}
	}
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				Random random = new Random((long) ((this.anInt9525) * -2017522141));
				for (;;) {
					int i_17_ = i_10_ + TranslatedCanvas.method3039(random, i_11_ - i_10_, (byte) 36);
					int i_18_ = i_12_ + TranslatedCanvas.method3039(random, i_13_ - i_12_, (byte) -88);
					...
					if (Class250.anInt2755 * -1474554145 == i_19_) {
						...
						i_9_ = 0;
						i_4_ = i_3_;
						i_3_ = TranslatedCanvas.method3039(random, (-1474554145 * (Class250.anInt2755)), (byte) -66);
						i_2_ = i_3_ - i_4_;
						i_5_ = 0;
						int i_38_ = i_2_;
						if (i_38_ < 0)
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahv.i(").append(')').toString());
		}
	}
	...
	int[] method3347(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			Random random = new Random((long) (this.anInt9525 * -2017522141));
			for (;;) {
				int i_57_ = (i_50_ + TranslatedCanvas.method3039(random, i_51_ - i_50_, (byte) -66));
				int i_58_ = (i_52_ + TranslatedCanvas.method3039(random, i_53_ - i_52_, (byte) -28));
				...
				if (Class250.anInt2755 * -1474554145 == i_59_) {
					...
					i_49_ = 0;
					i_44_ = i_43_;
					i_43_ = TranslatedCanvas.method3039(random, (-1474554145 * (Class250.anInt2755)), (byte) -49);
					i_42_ = i_43_ - i_44_;
					i_45_ = 0;
					int i_78_ = i_42_;
					if (i_78_ < 0)
	...
	void method3137(int i, Buffer buffer) {
		try {
			switch (i) {
			case 6:
				this.anInt9531 = buffer.readUByte() * 1663137711;
				break;
			case 7:
				this.anInt9532 = buffer.readUShort() * 741927281;
				break;
			case 1:
				this.anInt9526 = buffer.readUShort() * -8002361;
				break;
			case 0:
				this.anInt9525 = buffer.readUByte() * -653192821;
				break;
			case 4:
				this.anInt9519 = buffer.readUShort() * 1340421019;
				break;
			case 3:
				this.anInt9528 = buffer.readUShort() * -2128158391;
				break;
			case 5:
				this.anInt9530 = buffer.readUShort() * -420846851;
				break;
			case 2:
				this.anInt9523 = buffer.readUShort() * 334398233;
				break;
			case 8:
				this.anInt9533 = buffer.readUShort() * 1393727635;
				break;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahv.r(").append(')').toString());
		}
	}
	...
	int[] method3348(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			Random random = new Random((long) (this.anInt9525 * -2017522141));
			for (;;) {
				int i_98_ = (i_91_ + TranslatedCanvas.method3039(random, i_92_ - i_91_, (byte) 96));
				int i_99_ = (i_93_ + TranslatedCanvas.method3039(random, i_94_ - i_93_, (byte) 8));
				...
				if (Class250.anInt2755 * -1474554145 == i_100_) {
					...
					i_90_ = 0;
					i_85_ = i_84_;
					i_84_ = TranslatedCanvas.method3039(random, (-1474554145 * (Class250.anInt2755)), (byte) -56);
					i_83_ = i_84_ - i_85_;
					i_86_ = 0;
					int i_119_ = i_83_;
					if (i_119_ < 0)
	...
	final void method3349(Random random, int[][] is, int i, int i_122_, int i_123_, int i_124_, int i_125_) {
		try {
			int i_126_ = (this.anInt9533 * -2052438629 > 0 ? (4096 - TranslatedCanvas.method3039(random, (this.anInt9533 * -2052438629), (byte) 90)) : 4096);
			int i_127_ = ((908540917 * this.anInt9534 * (this.anInt9532 * 19183505)) >> 12);
			int i_128_ = (this.anInt9534 * 908540917 - (i_127_ > 0 ? TranslatedCanvas.method3039(random, i_127_, (byte) -95) : 0));
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahv.ac(").append(')').toString());
		}
	}
	...
	void method3352(int i, Buffer class298_sub53) {
		switch (i) {
		case 6:
			this.anInt9531 = class298_sub53.readUByte() * 1663137711;
			break;
	...
	void method3133(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahv.posX(").append(')').toString());
		}
	}
}
