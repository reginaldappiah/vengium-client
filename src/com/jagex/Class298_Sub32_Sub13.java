package com.jagex;/* Class298_Sub32_Sub13 - Decompiled by JODE
...
public class Class298_Sub32_Sub13 extends Class298_Sub32 {
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahb.i(").append(')').toString());
		}
	}
	...
	int method3212(int i, int i_5_, byte i_6_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahb.ac(").append(')').toString());
		}
	}
