package com.jagex;/* Class213 - Decompiled by JODE
...
public abstract class Class213 {
	...
	void method1962() {
		...
		for (int i = 0; i < this.anInt2443; i++)
			this.aShortArray2436[i] = (short) (int) Math.pow(2.0, (double) i);
	}
	...
	void method1964() {
		Random random = new Random((long) this.anInt2439);
		for (int i = 0; i < 255; i++)
			this.aShortArray2434[i] = (short) i;
		for (int i = 0; i < 255; i++) {
			int i_47_ = 255 - i;
			int i_48_ = TranslatedCanvas.method3039(random, i_47_, (byte) -33);
