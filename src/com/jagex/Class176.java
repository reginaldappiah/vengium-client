package com.jagex;/* Class176 - Decompiled by JODE
...
public class Class176 {
	...
	void method1827(NativeToolkit class_ra_sub3) {
	...
	void method1829(NativeToolkit class_ra_sub3, Class69 class69) {
		class_ra_sub3.RA(false);
		aFloat1786 = class_ra_sub3.aFloat8291;
		float f = class_ra_sub3.aMatrix4f_8230.aFloatArray2594[2];
		float f_0_ = class_ra_sub3.aMatrix4f_8230.aFloatArray2594[6];
		float f_1_ = class_ra_sub3.aMatrix4f_8230.aFloatArray2594[10];
		float f_2_ = class_ra_sub3.aMatrix4f_8230.aFloatArray2594[14];
		int i = 0;
		int i_3_ = 2147483647;
		int i_4_ = 0;
		...
		int i_8_;
		if (i_7_ + 2 > 1600) {
			i_8_ = (1 + StaticMethods.method970(i_7_, -1647802809) - this.anInt1783);
			i_7_ = (i_7_ >> i_8_) + 2;
		} else {
			i_8_ = 0;
			i_7_ += 2;
		...
		class130.method1452(Matrix4f.aMatrix4f_2595);
		class130.aMatrix4f_1494.method2172();
		class130.colorValue = -1;
		int i_10_ = -2;
		boolean bool = true;
		...
		while (class302_sub3_9_ != class302_sub3) {
			...
			if (bool && class_ra_sub3.aFloat8291 != aFloat1786)
				class_ra_sub3.setModelAmbient(aFloat1786);
			else if (class_ra_sub3.aFloat8291 != 1.0F)
				class_ra_sub3.setModelAmbient(1.0F);
	...
	void method1830(NativeToolkit class_ra_sub3, int i) {
		int i_15_ = 0;
		Matrix4f matrix4f = class_ra_sub3.aMatrix4f_8230;
		float f = matrix4f.aFloatArray2594[0];
		float f_16_ = matrix4f.aFloatArray2594[4];
		float f_17_ = matrix4f.aFloatArray2594[8];
		float f_18_ = matrix4f.aFloatArray2594[1];
		float f_19_ = matrix4f.aFloatArray2594[5];
		float f_20_ = matrix4f.aFloatArray2594[9];
		float f_21_ = f + f_18_;
	...
	Class176(NativeToolkit class_ra_sub3) {
		this.anInt1783 = StaticMethods.method970(1600, 308928473);
		this.anInt1779 = 64;
