package com.jagex;/* Class232 - Decompiled by JODE
...
public class Class232 {
	...
	public final void method2138(Matrix4f matrix4f) {
		float f = aFloat2593;
		float f_6_ = aFloat2592;
		float f_7_ = aFloat2590;
		float f_8_ = aFloat2591;
		aFloat2593 = (matrix4f.aFloatArray2594[0] * f + matrix4f.aFloatArray2594[4] * f_6_ + matrix4f.aFloatArray2594[8] * f_7_ + matrix4f.aFloatArray2594[12] * f_8_);
		aFloat2592 = (matrix4f.aFloatArray2594[1] * f + matrix4f.aFloatArray2594[5] * f_6_ + matrix4f.aFloatArray2594[9] * f_7_ + matrix4f.aFloatArray2594[13] * f_8_);
		aFloat2590 = (matrix4f.aFloatArray2594[2] * f + matrix4f.aFloatArray2594[6] * f_6_ + matrix4f.aFloatArray2594[10] * f_7_ + matrix4f.aFloatArray2594[14] * f_8_);
		aFloat2591 = (matrix4f.aFloatArray2594[3] * f + matrix4f.aFloatArray2594[7] * f_6_ + matrix4f.aFloatArray2594[11] * f_7_ + matrix4f.aFloatArray2594[15] * f_8_);
	}
