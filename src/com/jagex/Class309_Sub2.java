package com.jagex;/* Class309_Sub2 - Decompiled by JODE
...
public class Class309_Sub2 extends Class309 {
    ...
    long method3794(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aau.k(").append(')').toString());
		}
	}
    ...
    int method3791(long updateInterval) {
		try {
			if (2528788777947664827L * this.aLong7683 > 7092803054136495365L * this.aLong7686) {
				...
				this.aLong7683 += updateInterval * -8587934381355922573L;
				return 1;
			}
			int i = 0;
			do {
				i++;
				this.aLong7683 += -8587934381355922573L * updateInterval;
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aau.i(").append(')').toString());
		}
	}
	...
	void method3788() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aau.b(").append(')').toString());
		}
	}
    ...
    long method3789() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aau.p(").append(')').toString());
		}
	}
    ...
    long method3808(int i) {
		try {
			...
			return (l_1_ / (long) (this.anInt7682 * 769935805));
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aau.e(").append(')').toString());
		}
	}
