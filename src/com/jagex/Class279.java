package com.jagex;/* Class279 - Decompiled by JODE
...
public class Class279 {
	...
	final int method2605(int i) {
		if (this.anInt2980 >= this.anInt2976) {
			...
			this.anInt2976 = (int) ((double) (this.anIntArray2971[this.anInt2977]) / 65536.0 * (double) i);
	...
	final void method2606(Buffer class298_sub53) {
		this.anInt2975 = class298_sub53.readUByte();
		this.anInt2973 = class298_sub53.readInt();
		this.anInt2974 = class298_sub53.readInt();
		method2607(class298_sub53);
	}

	final void method2607(Buffer class298_sub53) {
		this.anInt2979 = class298_sub53.readUByte();
		this.anIntArray2971 = new int[this.anInt2979];
		this.anIntArray2972 = new int[this.anInt2979];
		for (int i = 0; i < this.anInt2979; i++) {
			this.anIntArray2971[i] = class298_sub53.readUShort();
			this.anIntArray2972[i] = class298_sub53.readUShort();
		}
	}
