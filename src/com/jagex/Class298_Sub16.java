package com.jagex;/* Class298_Sub16 - Decompiled by JODE
...
public class Class298_Sub16 extends Node {
	int anInt7282;
	...
	NativeToolkit aClass_ra_Sub3_7288;
	int[] anIntArray7289;
	int anInt7290 = 0;
	int anInt7291;
	int anInt7292;
	NativeHeapBuffer heapBuffer;
	float aFloat7294;

	void method2910(int i) {
		this.heapBuffer = this.aClass_ra_Sub3_7288.method5517(i * 4, true);
		this.stream = new Stream(this.heapBuffer, 0, i * 4);
	}
	...
	void method2913(int i, int i_2_, int i_3_, float f) {
		if (this.anInt7284 != -1) {
			Class53 class53 = this.aClass_ra_Sub3_7288.textures.method174(this.anInt7284);
		...
		this.stream.b(i * 4);
		if ((this.aClass_ra_Sub3_7288.samples) == 0) {
			this.stream.p((byte) i_2_);
			this.stream.p((byte) (i_2_ >> 8));
			this.stream.p((byte) (i_2_ >> 16));
		} else {
			this.stream.p((byte) (i_2_ >> 16));
			this.stream.p((byte) (i_2_ >> 8));
			this.stream.p((byte) i_2_);
	...
	void method2914(int i) {
		...
		this.anInterface7_Impl1_7287.method71(i * 4, 4, this.heapBuffer);
	...
	Class298_Sub16(Class_xa_Sub1 class_xa_sub1, int i, int i_23_, Class78 class78) {
		...
		byte i_24_ = 10;
		if (i >= 0) {
			Class53 class53 = this.aClass_ra_Sub3_7288.textures.method174(i);
