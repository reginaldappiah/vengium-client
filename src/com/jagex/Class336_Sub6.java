package com.jagex;/* Class336_Sub6 - Decompiled by JODE
...
public class Class336_Sub6 extends Class336 {
	...
	public boolean method4090(int i, int i_4_, int i_5_, Class289 class289, int i_6_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("acy.a(").append(')').toString());
		}
	}

	static final void method4106(ScriptRuntime runtime) {
		try {
			String string = (String) (runtime.objectStack[(runtime.objectArgs -= 969361751) * -203050393]);
			Class12.method338(string, true, (short) 5563);
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("acy.ww(").append(')').toString());
		}
	}

	public static void method4107(HuffmanCodec class113) {
		try {
	...
	public static Class424[] method4108() {
		try {
