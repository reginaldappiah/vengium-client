package com.jagex;/* Class168 - Decompiled by JODE
...
public class Class168 {
	...
	FrameBufferContext aClass52_Sub1_1712;
	...
	NativeToolkit aClass_ra_Sub3_1717;
	...
	Class168(NativeToolkit class_ra_sub3, int i, int i_0_) {
	...
	void method1790() {
		...
		for (int i_1_ = 0; i_1_ < i; i_1_++) {
			BloomToolkit bloomToolkit = (BloomToolkit) this.aVector1715.elementAt(i_1_);
			int i_2_ = bloomToolkit.method1624();
			boolean bool = i_1_ == i - 1;
			for (int i_3_ = 0; i_3_ < i_2_; i_3_++) {
				if (bool && i_3_ == i_2_ - 1)
					this.aClass_ra_Sub3_1717.method5005(this.aClass52_Sub1_1712);
				else
				...
				bloomToolkit.method1633(i_3_, this.aClass52_Sub1_1712, interface9_impl2_impl1, (this.anInterface8_Impl1_Impl2_1719), (this.anInterface9_Impl2_Impl1_1711));
				method1797();
				bloomToolkit.method1623(i_3_);
	...
	void method1791() {
		...
		for (int i_5_ = 0; i_5_ < i; i_5_++) {
			BloomToolkit bloomToolkit = (BloomToolkit) this.aVector1715.elementAt(i_5_);
			bloomToolkit.method1621(this.anInt1720, this.anInt1721);
		}
	}

	boolean method1792(BloomToolkit bloomToolkit) {
		return method1793(this.aVector1715.size(), bloomToolkit);
	}

	boolean method1793(int size, BloomToolkit bloomToolkit) {
		if (bloomToolkit.method1617() || bloomToolkit.method1618()) {
			this.aVector1715.insertElementAt(bloomToolkit, size);
			bloomToolkit.method1621(this.anInt1720, this.anInt1721);
			int i_6_ = bloomToolkit.method1625();
			if (i_6_ > this.anInt1725)
				this.anInt1725 = i_6_;
			bloomToolkit.aBoolean1586 = true;
			return true;
		}
		method1795(bloomToolkit);
		return true;
	}
	...
	void method1795(BloomToolkit bloomToolkit) {
		bloomToolkit.method1620();
		bloomToolkit.aBoolean1586 = false;
		this.aVector1715.removeElement(bloomToolkit);
	}

	void method1796() {
		this.aClass52_Sub1_1712.destroy();
		...
		for (int i_7_ = 0; i_7_ < i; i_7_++) {
			BloomToolkit bloomToolkit = (BloomToolkit) this.aVector1715.elementAt(i_7_);
			bloomToolkit.method1620();
		}
	}
	...
	boolean method1798(int i, int i_8_, int i_9_, int i_10_) {
		if (this.aVector1715.isEmpty())
			return false;
		if (this.anInt1720 != i_9_ || (this.anInt1721 != i_10_ && (this.aClass_ra_Sub3_1717 instanceof OpenGLXGraphicsToolkit))) {
			this.anInt1720 = i_9_;
		...
		this.aClass_ra_Sub3_1717.switchContext(this.aClass52_Sub1_1712);
		this.aClass_ra_Sub3_1717.clear(3, -16777216);
