package com.jagex;/* Class128_Sub3 - Decompiled by JODE
...
public class Class128_Sub3 extends Class128 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("zx.f(").append(')').toString());
		}
	}
	...
	static final void method1442(ScriptRuntime class403, int i) {
		try {
			...
			if (null == integer) {
				...
				class403.integerStack[((class403.integerStackOffset += -391880689) * 681479919) - 1] = integer.intValue();
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("zx.bq(").append(')').toString());
		}
	}
}
