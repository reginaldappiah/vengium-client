...
public class Class2 {
	...
	final void method290(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1) {
		...
		if (i1 != anInt37) {
			...
			if (anIntArray30 == null) {
				...
				int j1 = Class379.anIntArray4096[Class173.method1823(aClass_ra_Sub1_31.method5206(i1)) & 0xffff];
				int k1 = 0xff000000 | (i >> 16 & 0xff) * (j1 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (j1 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (j1 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, StaticMethods.method4215(k1, l, f18), StaticMethods.method4215(k1, l, f19), StaticMethods.method4215(k1, l, f20));
				return;
			}
	...
	final void method292(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int i, int j, int k) {
		...
		if (aBoolean36) {
			aClass_ra_Sub1_31.drawDiagnolLine((int) f3, (int) f, (int) f4, (int) f1, 0xff000000 | i);
			aClass_ra_Sub1_31.drawDiagnolLine((int) f4, (int) f1, (int) f5, (int) f2, 0xff000000 | i);
			aClass_ra_Sub1_31.drawDiagnolLine((int) f5, (int) f2, (int) f3, (int) f, 0xff000000 | i);
			return;
		}
		float f9 = f4 - f3;
		float f10 = f1 - f;
	...
	final void method293(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, int i) {
		if (aBoolean36) {
			aClass_ra_Sub1_31.drawDiagnolLine((int) f3, (int) f, (int) f4, (int) f1, i);
			aClass_ra_Sub1_31.drawDiagnolLine((int) f4, (int) f1, (int) f5, (int) f2, i);
			aClass_ra_Sub1_31.drawDiagnolLine((int) f5, (int) f2, (int) f3, (int) f, i);
			return;
		}
		float f9 = f4 - f3;
		float f10 = f1 - f;
	...
	final void method296(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, int i, int j, int k, int l, float f18, float f19, float f20, int i1, float f21, int j1, float f22, int k1, float f23) {
		...
		if (i1 != anInt37) {
			...
			if (anIntArray30 == null) {
				anInt19 = 255 - (i >> 24 & 0xff);
				int l1 = Class379.anIntArray4096[Class173.method1823(aClass_ra_Sub1_31.method5206(i1)) & 0xffff];
				int i3 = 0xff000000 | (i >> 16 & 0xff) * (l1 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (l1 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (l1 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, StaticMethods.method4215(i3, l, f18), StaticMethods.method4215(i3, l, f19), StaticMethods.method4215(i3, l, f20));
				return;
			}
			anInt39 = aClass_ra_Sub1_31.method5199(i1) ? 64 : aClass_ra_Sub1_31.anInt8002 * 0x420409cb;
			anInt40 = anInt39 - 1;
		...
		if (j1 != anInt44) {
			...
			if (anIntArray45 == null) {
				anInt19 = 255 - (i >> 24 & 0xff);
				int i2 = Class379.anIntArray4096[Class173.method1823(aClass_ra_Sub1_31.method5206(j1)) & 0xffff];
				int j3 = 0xff000000 | (i >> 16 & 0xff) * (i2 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (i2 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (i2 & 0xff) >> 8;
				method292(true, flag1, flag2, f, f1, f2, f3, f4, f5, f6, f7, f8, StaticMethods.method4215(j3, l, f18), StaticMethods.method4215(j3, l, f19), StaticMethods.method4215(j3, l, f20));
				return;
			}
		...
		if (k1 != anInt49) {
			...
			if (anIntArray50 == null) {
				anInt19 = 255 - (i >> 24 & 0xff);
				int j2 = Class379.anIntArray4096[Class173.method1823(aClass_ra_Sub1_31.method5206(k1)) & 0xffff];
				int k3 = 0xff000000 | (i >> 16 & 0xff) * (j2 >> 16 & 0xff) << 8 & 0xff0000 | (i >> 8 & 0xff) * (j2 >> 8 & 0xff) & 0xff00 | (i & 0xff) * (j2 & 0xff) >> 8;
				method292(true, flag1, flag2, (int) f, (int) f1, (int) f2, (int) f3, (int) f4, (int) f5, (int) f6, (int) f7, (int) f8, StaticMethods.method4215(k3, l, f18), StaticMethods.method4215(k3, l, f19), StaticMethods.method4215(k3, l, f20));
				return;
			}
	...
	Class2(JavaGraphicsToolkit class_ra_sub1, Class15 class15) {
		aBoolean36 = false;
		aBoolean16 = true;
		aBoolean48 = false;
		anInt19 = 0;
		...
		aClass15_24 = class15;
		anInt33 = aClass_ra_Sub1_31.width * 0x2940b683;
	...
	final void method299(boolean flag, boolean flag1, boolean flag2, float f, float f1, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11) {
		...
		if (aBoolean36) {
			aClass_ra_Sub1_31.drawDiagnolLine((int) f3, (int) f, (int) f4, (int) f1, Class379.anIntArray4096[(int) f9 & 0xffff]);
			aClass_ra_Sub1_31.drawDiagnolLine((int) f4, (int) f1, (int) f5, (int) f2, Class379.anIntArray4096[(int) f9 & 0xffff]);
			aClass_ra_Sub1_31.drawDiagnolLine((int) f5, (int) f2, (int) f3, (int) f, Class379.anIntArray4096[(int) f9 & 0xffff]);
			return;
		}
		float f12 = f4 - f3;
		float f13 = f1 - f;
	...
	int anInt29;
	int anIntArray30[];
	JavaGraphicsToolkit aClass_ra_Sub1_31;
	float aFloat32;
	int anInt33;
	int anIntArray34[];
	float aFloatArray35[];
