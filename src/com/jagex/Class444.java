package com.jagex;/* Class444 - Decompiled by JODE
...
public class Class444 {
	...
	public static Class444 method5888(int i, byte i_0_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("si.f(").append(')').toString());
		}
	}

	public static void method5889(ScriptNode scriptNode) {
			ToMoveScripts.onLoadHook(scriptNode, 200000);
	}
	...
	static void method5890(byte i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("si.i(").append(')').toString());
		}
	}
}
