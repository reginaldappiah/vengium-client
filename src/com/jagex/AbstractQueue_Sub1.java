package com.jagex;/* AbstractQueue_Sub1 - Decompiled by JODE
...
public class AbstractQueue_Sub1 extends AbstractQueue {
	...
	void method6383(int i, int i_0_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.b(").append(')').toString());
		}
	}
	...
	void method6384(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.a(").append(')').toString());
		}
	}
	...
	public int size() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.tileSpacesOccupied(").append(')').toString());
		}
	}
	...
	public boolean contains(Object object) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.contains(").append(')').toString());
		}
	}
	...
	public Object poll() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.poll(").append(')').toString());
		}
	}
	...
	void method6385(int i, int i_8_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.f(").append(')').toString());
		}
	}
	...
	public Object[] toArray() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.toArray(").append(')').toString());
		}
	}
	...
	public Iterator iterator() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.iterator(").append(')').toString());
		}
	}
	...
	public Object peek() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.peek(").append(')').toString());
		}
	}
	...
	public boolean offer(Object object) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.offer(").append(')').toString());
		}
	}
	...
	public boolean remove(Object object) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.remove(").append(')').toString());
		}
	}

	static final void method6386(ScriptRuntime class403, byte i) {
		try {
			Class419.executeCommand((String) (class403.objectStack[(class403.objectArgs -= 969361751) * -203050393]), false, false);
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ajy.afx(").append(')').toString());
		}
	}
}
