package com.jagex;/* OpenGLShaderToolkit - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */
import com.jagex.maths.Matrix4f;
import jaggl.OpenGL;

public class OpenGLShaderToolkit extends ShaderProgramToolkit {
	boolean aBoolean8603;
	float[] aFloatArray8604;
	static int anInt8605 = 13;
	OpenGLXGraphicsToolkit aOpenGLJavaGraphicsToolkit_8606;
	...
	OpenGLShaderToolkit(OpenGLXGraphicsToolkit openGLJavaGraphicsToolkit, Class108 class108) {
		...
		if (class108.aString1316 != null) {
			...
			stringbuilder.append(new String(openGLJavaGraphicsToolkit.method5535(aString6400)));
		...
		if (class108.aString1318 != null) {
			...
			stringbuilder.append(new String(openGLJavaGraphicsToolkit.method5535(aString6401)));
			this.aString8616 = stringbuilder.toString();
		}
		Class425.method5740(this.anIntArray8612, 0, this.anIntArray8612.length, -1);
	}

	void glColor3f(ShaderProgram class298_sub31_sub1, float f, float f_0_, float f_1_) {
	...
	void method1161(ShaderProgram class298_sub31_sub1, float f, float f_2_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void glColor4f(ShaderProgram program, float f, float f_4_, float f_5_, float f_6_) {
		int i = ((Class298_Sub31_Sub1_Sub1) program).method3125();
		if (i != -1) {
			if (this.aFloatArray8621[i] != f || this.aFloatArray8619[i] != f_4_ || this.aFloatArray8604[i] != f_5_ || this.aFloatArray8618[i] != f_6_) {
				...
				if (program.method3118(-1326694725) != Class100.aClass100_1001)
	...
	void method1192(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		...
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform2fv(i, 4, matrix4f.method2162(aFloatArray8614), 0);
	}
	...
	void method1166(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		...
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1)
			OpenGL.glUniform4fv(i, 4, matrix4f.method2173(aFloatArray8614), 0);
	}

	void method1186(ShaderProgram class298_sub31_sub1, float f, float f_8_, float f_9_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1158(int i, int i_15_, Interface9 interface9) {
		this.aOpenGLJavaGraphicsToolkit_8606.method5357(i_15_);
		this.aOpenGLJavaGraphicsToolkit_8606.method5358(interface9);
		OpenGL.glUniform1i(i, i_15_);
	}

	void method1171(int i, Matrix4f matrix4f) {
		OpenGL.glUniform3fv(i, 3, matrix4f.method2165(aFloatArray8614), 0);
	}
	...
	void method1174(int i, int i_16_, Interface9 interface9) {
		this.aOpenGLJavaGraphicsToolkit_8606.method5357(i_16_);
		this.aOpenGLJavaGraphicsToolkit_8606.method5358(interface9);
	...
	public void b() {
		if (this.anInt8608 != 0) {
			this.aOpenGLJavaGraphicsToolkit_8606.method5538(this.anInt8608);
			if (this.anInt8609 != 0)
				this.aOpenGLJavaGraphicsToolkit_8606.method5531((long) this.anInt8609);
			if (this.anInt8615 != 0)
				this.aOpenGLJavaGraphicsToolkit_8606.method5531((long) this.anInt8615);
			this.anInt8608 = 0;
			this.anInt8609 = 0;
			this.anInt8615 = 0;
		}
	...
	void method1191(ShaderProgram class298_sub31_sub1, float f, float f_17_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1212(ShaderProgram class298_sub31_sub1, int i, Interface9 interface9) {
		...
		if (i_18_ != -1) {
			if (interface9 == null)
				interface9 = (this.aOpenGLJavaGraphicsToolkit_8606.anInterface9_Impl2_8310);
			if (i < this.aOpenGLJavaGraphicsToolkit_8606.anInt8347) {
				this.aOpenGLJavaGraphicsToolkit_8606.method5357(i);
				this.aOpenGLJavaGraphicsToolkit_8606.method5358(interface9);
			} else {
	...
	public boolean method1209() {
		if (this.aBoolean8603)
			return true;
		this.aOpenGLJavaGraphicsToolkit_8606.aClass110_Sub2_9832 = null;
		...
		int i = -1;
		for (int i_19_ = 0; i_19_ < this.aClass123_Sub2_8607.method1328(); i_19_++) {
		...
		for (int i_22_ = 0; i_22_ < this.aClass123_Sub2_8607.method1323(-1707407208); i_22_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub2_8607.method1352(i_22_, 444661617);
		...
		for (int i_24_ = 0; i_24_ < this.aClass123_Sub2_8607.method1350((byte) -98); i_24_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub2_8607.method1370(i_24_, 1888215794);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
	...
	public boolean method1180() {
		...
		OpenGL.glUseProgram(this.anInt8608);
		int i = -1;
		for (int i_27_ = 0; i_27_ < this.aClass123_Sub2_8607.method1328(); i_27_++) {
		...
		for (int i_30_ = 0; i_30_ < this.aClass123_Sub2_8607.method1323(-392444295); i_30_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub2_8607.method1352(i_30_, 444661617);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
		...
		for (int i_32_ = 0; i_32_ < this.aClass123_Sub2_8607.method1350((byte) -19); i_32_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub2_8607.method1370(i_32_, 1888215794);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
	...
	void method1165(ShaderProgram class298_sub31_sub1, float f, float f_36_, float f_37_, float f_38_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1188(ShaderProgram class298_sub31_sub1, float f, float f_43_, float f_44_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1179(ShaderProgram class298_sub31_sub1, float f, float f_45_, float f_46_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1189(ShaderProgram class298_sub31_sub1, float f, float f_47_, float f_48_, float f_49_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	OpenGLShaderToolkit(OpenGLXGraphicsToolkit openGLJavaGraphicsToolkit, Class123_Sub2 class123_sub2, Class108 class108) {
		this(openGLJavaGraphicsToolkit, class108);
		this.aClass123_Sub2_8607 = class123_sub2;
		this.aOpenGLJavaGraphicsToolkit_8606 = openGLJavaGraphicsToolkit;
	}

	void method1178(ShaderProgram class298_sub31_sub1, float f, float f_52_, float f_53_, float f_54_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1193(ShaderProgram class298_sub31_sub1, float f, float f_55_, float f_56_, float f_57_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1194(ShaderProgram class298_sub31_sub1, float f, float f_58_, float f_59_, float f_60_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1205(ShaderProgram class298_sub31_sub1, float f, float f_65_, float f_66_, float f_67_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	void method1185(ShaderProgram class298_sub31_sub1, float f, float f_71_) {
		int i = ((Class298_Sub31_Sub1_Sub1) class298_sub31_sub1).method3125();
		if (i != -1) {
	...
	static {
		aBoolean8622 = !OpenGLShaderToolkit.class.desiredAssertionStatus();
	...
	void method1218(int i, int i_79_, Interface9 interface9) {
		this.aOpenGLJavaGraphicsToolkit_8606.method5357(i_79_);
		this.aOpenGLJavaGraphicsToolkit_8606.method5358(interface9);
	...
	public boolean method1221() {
		...
		OpenGL.glUseProgram(this.anInt8608);
		int i = -1;
		for (int i_80_ = 0; i_80_ < this.aClass123_Sub2_8607.method1328(); i_80_++) {
		...
		for (int i_83_ = 0; i_83_ < this.aClass123_Sub2_8607.method1323(-851486259); i_83_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub2_8607.method1352(i_83_, 444661617);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
		...
		for (int i_85_ = 0; i_85_ < this.aClass123_Sub2_8607.method1350((byte) -85); i_85_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub2_8607.method1370(i_85_, 1888215794);
			if (class298_sub31_sub1 != null) {
				class298_sub31_sub1.method3124(i);
	...
	void method1220(int i, int i_88_, Interface9 interface9) {
		this.aOpenGLJavaGraphicsToolkit_8606.method5357(i_88_);
		this.aOpenGLJavaGraphicsToolkit_8606.method5358(interface9);
		OpenGL.glUniform1i(i, i_88_);
	}

	void method1199(int i, int i_89_, Interface9 interface9) {
		this.aOpenGLJavaGraphicsToolkit_8606.method5357(i_89_);
		this.aOpenGLJavaGraphicsToolkit_8606.method5358(interface9);
