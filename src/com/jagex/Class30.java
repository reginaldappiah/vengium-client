package com.jagex;/* Class30 - Decompiled by JODE
...
public abstract class Class30 {
	...
	boolean aBoolean379;
	int anInt380;
	OpenGLGraphicsToolkit aClass_ra_Sub2_381;
	static int[] anIntArray382 = new int[1];

	Class30(OpenGLGraphicsToolkit class_ra_sub2, int i, Class55 class55, Class77 class77, int i_0_, boolean bool) {
	...
	static void method412(int i, int i_26_, int i_27_, int i_28_, Class55 class55, byte[] is) {
		if (i_27_ > 0 && !StaticMethods.method6152(i_27_))
			throw new IllegalArgumentException("");
		if (i_28_ > 0 && !StaticMethods.method6152(i_28_))
			throw new IllegalArgumentException("");
		...
		for (;;) {
			OpenGL.glTexImage2Dub(i, i_30_, i_26_, i_27_, i_28_, 0, OpenGLGraphicsToolkit.method5228(class55), 5121, is_34_, 0);
			if (i_31_ <= 1)
				break;
	...
	boolean method413() {
		if (this.aClass_ra_Sub2_381.aBoolean8170) {
			int i = method416();
			this.aClass_ra_Sub2_381.method5256(this);
	...
	static void method415(int i, int i_45_, int i_46_, int i_47_, Class55 class55, float[] fs) {
		if (i_46_ > 0 && !StaticMethods.method6152(i_46_))
			throw new IllegalArgumentException("");
		if (i_47_ > 0 && !StaticMethods.method6152(i_47_))
			throw new IllegalArgumentException("");
		...
		for (;;) {
			OpenGL.glTexImage2Df(i, i_49_, i_45_, i_46_, i_47_, 0, OpenGLGraphicsToolkit.method5228(class55), 5126, fs_53_, 0);
			if (i_50_ <= 1)
				break;
