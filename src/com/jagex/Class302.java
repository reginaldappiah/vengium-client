package com.jagex;/* Class302 - Decompiled by JODE
...
public class Class302 {
	...
	public void unlink() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("mo.a(").append(')').toString());
		}
	}

	static final void method3715(ScriptRuntime class403, byte i) {
		try {
			Class92.method1007();
			Class436.aBoolean5496 = false;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("mo.afj(").append(')').toString());
		}
	}

	static boolean method3716(int i) {
		try {
			if (9 == i || i == 10 || i == 11 || i == 12 || i == 13 || 1003 == i)
				return true;
			return i == 8;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("mo.bb(").append(')').toString());
		}
	}
	...
	static final void method3717(long l) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("mo.f(").append(')').toString());
		}
	}
		...
		try {
			if (i != i_2_ || i_3_ != i_1_ || i_6_ != i_4_ || i_5_ != i_7_) {
				...
				for (int i_24_ = 128; i_24_ <= 4096; i_24_ += 128) {
					...
					Class264_Sub1.method2503(i_10_, i_11_, i_33_, i_34_, i_8_);
					i_10_ = i_33_;
					i_11_ = i_34_;
				}
			} else
				Class264_Sub1.method2503(i, i_1_, i_6_, i_7_, i_8_);
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("mo.ax(").append(')').toString());
		}
	}
}
