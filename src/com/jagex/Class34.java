package com.jagex;/* Class34 - Decompiled by JODE
...
public class Class34 {
	...
	void method436(OpenGLGraphicsToolkit class_ra_sub2, Class69 class69) {
		if (class_ra_sub2.aMatrix4f_8110 != null) {
			method438(class_ra_sub2);
			float f = (class_ra_sub2.aMatrix4f_8110.aFloatArray2594[2]);
			float f_0_ = (class_ra_sub2.aMatrix4f_8110.aFloatArray2594[6]);
			float f_1_ = (class_ra_sub2.aMatrix4f_8110.aFloatArray2594[10]);
			float f_2_ = (class_ra_sub2.aMatrix4f_8110.aFloatArray2594[14]);
			try {
				int i = 0;
				int i_3_ = 2147483647;
				int i_4_ = 0;
				...
				int i_8_;
				if (i_7_ + 2 > 1600) {
					i_8_ = (1 + StaticMethods.method970(i_7_, 1151745545) - this.anInt408);
					i_7_ = (i_7_ >> i_8_) + 2;
				} else {
					i_8_ = 0;
					i_7_ += 2;
				...
				while (class302_sub3_9_ != class302_sub3) {
					...
					if (bool && (class_ra_sub2.aFloat8130 != aFloat402))
						class_ra_sub2.setModelAmbient(aFloat402);
					else if (class_ra_sub2.aFloat8130 != 1.0F)
						class_ra_sub2.setModelAmbient(1.0F);
	...
	void method437(OpenGLGraphicsToolkit class_ra_sub2, int i) {
		...
		this.aClass298_Sub53_Sub1_407.offset = 0;
			...
			for (int i_29_ = i - 1; i_29_ >= 0; i_29_--) {
				...
				if (i_30_ > 0) {
					for (int i_31_ = i_30_ - 1; i_31_ >= 0; i_31_--) {
						...
						this.aClass298_Sub53_Sub1_407.method3658(0.0F);
						this.aClass298_Sub53_Sub1_407.method3658(f_37_ + f_20_ * (float) -i_40_);
						this.aClass298_Sub53_Sub1_407.method3658(f_38_ + f_21_ * (float) -i_40_);
						this.aClass298_Sub53_Sub1_407.method3658(f_39_ + f_22_ * (float) -i_40_);
						...
						this.aClass298_Sub53_Sub1_407.method3658(f_37_ + f_26_ * (float) i_40_);
						this.aClass298_Sub53_Sub1_407.method3658(f_38_ + f_27_ * (float) i_40_);
						this.aClass298_Sub53_Sub1_407.method3658(f_39_ + f_28_ * (float) i_40_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_33_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_34_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_35_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_36_);
						...
						this.aClass298_Sub53_Sub1_407.method3658(1.0F);
						this.aClass298_Sub53_Sub1_407.method3658(0.0F);
						this.aClass298_Sub53_Sub1_407.method3658(f_37_ + f_23_ * (float) i_40_);
						this.aClass298_Sub53_Sub1_407.method3658(f_38_ + f_24_ * (float) i_40_);
						this.aClass298_Sub53_Sub1_407.method3658(f_39_ + f_25_ * (float) i_40_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_33_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_34_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_35_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_36_);
					...
					if (this.anIntArray411[i_29_] > 64) {
						...
						for (int i_42_ = this.anIntArray412[i_41_] - 1; i_42_ >= 0; i_42_--) {
							...
							this.aClass298_Sub53_Sub1_407.method3658(0.0F);
							this.aClass298_Sub53_Sub1_407.method3658(0.0F);
							this.aClass298_Sub53_Sub1_407.method3658(f_48_ + f_20_ * (float) -i_51_);
							this.aClass298_Sub53_Sub1_407.method3658(f_49_ + f_21_ * (float) -i_51_);
							this.aClass298_Sub53_Sub1_407.method3658(f_50_ + f_22_ * (float) -i_51_);
							...
							this.aClass298_Sub53_Sub1_407.method3658(0.0F);
							this.aClass298_Sub53_Sub1_407.method3658(1.0F);
							this.aClass298_Sub53_Sub1_407.method3658(f_48_ + f_26_ * (float) i_51_);
							this.aClass298_Sub53_Sub1_407.method3658(f_49_ + f_27_ * (float) i_51_);
							this.aClass298_Sub53_Sub1_407.method3658(f_50_ + f_28_ * (float) i_51_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_44_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_45_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_46_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_47_);
							...
							this.aClass298_Sub53_Sub1_407.method3658(1.0F);
							this.aClass298_Sub53_Sub1_407.method3658(0.0F);
							this.aClass298_Sub53_Sub1_407.method3658(f_48_ + f_23_ * (float) i_51_);
							this.aClass298_Sub53_Sub1_407.method3658(f_49_ + f_24_ * (float) i_51_);
							this.aClass298_Sub53_Sub1_407.method3658(f_50_ + f_25_ * (float) i_51_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_44_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_45_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_46_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_47_);
			...
			for (int i_52_ = i - 1; i_52_ >= 0; i_52_--) {
				...
				if (i_53_ > 0) {
					for (int i_54_ = i_53_ - 1; i_54_ >= 0; i_54_--) {
						...
						this.aClass298_Sub53_Sub1_407.method3659(0.0F);
						this.aClass298_Sub53_Sub1_407.method3659(f_60_ + f_20_ * (float) -i_63_);
						this.aClass298_Sub53_Sub1_407.method3659(f_61_ + f_21_ * (float) -i_63_);
						this.aClass298_Sub53_Sub1_407.method3659(f_62_ + f_22_ * (float) -i_63_);
						...
						this.aClass298_Sub53_Sub1_407.method3659(f_60_ + f_26_ * (float) i_63_);
						this.aClass298_Sub53_Sub1_407.method3659(f_61_ + f_27_ * (float) i_63_);
						this.aClass298_Sub53_Sub1_407.method3659(f_62_ + f_28_ * (float) i_63_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_56_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_57_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_58_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_59_);
						...
						this.aClass298_Sub53_Sub1_407.method3659(1.0F);
						this.aClass298_Sub53_Sub1_407.method3659(0.0F);
						this.aClass298_Sub53_Sub1_407.method3659(f_60_ + f_23_ * (float) i_63_);
						this.aClass298_Sub53_Sub1_407.method3659(f_61_ + f_24_ * (float) i_63_);
						this.aClass298_Sub53_Sub1_407.method3659(f_62_ + f_25_ * (float) i_63_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_56_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_57_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_58_);
						this.aClass298_Sub53_Sub1_407.writeByte(i_59_);
					...
					if (this.anIntArray411[i_52_] > 64) {
						...
						for (int i_65_ = this.anIntArray412[i_64_] - 1; i_65_ >= 0; i_65_--) {
							...
							this.aClass298_Sub53_Sub1_407.method3659(0.0F);
							this.aClass298_Sub53_Sub1_407.method3659(0.0F);
							this.aClass298_Sub53_Sub1_407.method3659(f_71_ + f_20_ * (float) -i_74_);
							this.aClass298_Sub53_Sub1_407.method3659(f_72_ + f_21_ * (float) -i_74_);
							this.aClass298_Sub53_Sub1_407.method3659(f_73_ + f_22_ * (float) -i_74_);
							...
							this.aClass298_Sub53_Sub1_407.method3659(0.0F);
							this.aClass298_Sub53_Sub1_407.method3659(1.0F);
							this.aClass298_Sub53_Sub1_407.method3659(f_71_ + f_26_ * (float) i_74_);
							this.aClass298_Sub53_Sub1_407.method3659(f_72_ + f_27_ * (float) i_74_);
							this.aClass298_Sub53_Sub1_407.method3659(f_73_ + f_28_ * (float) i_74_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_67_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_68_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_69_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_70_);
							...
							this.aClass298_Sub53_Sub1_407.method3659(1.0F);
							this.aClass298_Sub53_Sub1_407.method3659(0.0F);
							this.aClass298_Sub53_Sub1_407.method3659(f_71_ + f_23_ * (float) i_74_);
							this.aClass298_Sub53_Sub1_407.method3659(f_72_ + f_24_ * (float) i_74_);
							this.aClass298_Sub53_Sub1_407.method3659(f_73_ + f_25_ * (float) i_74_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_67_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_68_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_69_);
							this.aClass298_Sub53_Sub1_407.writeByte(i_70_);
		...
		if (this.aClass298_Sub53_Sub1_407.offset * 385051775 != 0) {
			this.anInterface1_403.method8(24, this.aClass298_Sub53_Sub1_407.buffer, (this.aClass298_Sub53_Sub1_407.offset * 385051775));
			class_ra_sub2.method5248(this.aClass32_405, null, this.aClass32_399, this.aClass32_404);
			class_ra_sub2.method5285(7, 0, (this.aClass298_Sub53_Sub1_407.offset) * 385051775 / 24);
		}
	}

	void method438(OpenGLGraphicsToolkit class_ra_sub2) {
	...
	Class34() {
		...
		this.anInt406 = 768;
		this.anInt400 = 1600;
		this.anInt408 = StaticMethods.method970(1600, -1704489835);
		this.anInt414 = 64;
	...
	void method439(OpenGLGraphicsToolkit class_ra_sub2) {
	...
	void method440(OpenGLGraphicsToolkit class_ra_sub2) {
