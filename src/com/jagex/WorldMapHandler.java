package com.jagex;/* Class301 - Decompiled by JODE
...
public class WorldMapHandler {
	...
	static UnderlayTypeLoader aClass451_3219;
	protected static ObjectDefinitionLoader aClass433_3220;
	...
	protected static Js5FileSystem worldMapIndex;
	...
	static OverlayDefinitionLoader overlayDefinitionLoader;
				...
				if (i_9_ < 0 || i_9_ >= anInt3239) {
					for (int i_10_ = 0; i_10_ < i_4_; i_10_++) {
						...
						if (aClass298_Sub37_Sub13_3218.anInt9639 * -717907215 != -1)
							...
							i_14_ = overlayCacheFiles[(overlayDefinitionLoader.anInt4080 * 1086398247) + 1];
						if (i_14_ == 0)
							i_14_ = -16777216;
						class_ra.drawFilledRectangle(i_6_, i_11_, i_8_, i_13_, i_14_, 0);
					}
				} else {
						...
						if (i_18_ > 0) {
							...
							if (i_21_ == 0 && i_22_ == 0 && object == null) {
								if ((aClass298_Sub37_Sub13_3218.anInt9639 * -717907215) != -1)
									...
									i_21_ = (overlayCacheFiles[(overlayDefinitionLoader.anInt4080 * 1086398247) + 1]);
								if (i_21_ == 0)
									i_21_ = -16777216;
								class_ra.drawFilledRectangle(i_6_, i_16_, i_8_, i_18_, i_21_, 0);
							} else if (object != null) {
				...
				for (int i_39_ = i_34_; i_39_ <= i_36_; i_39_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							...
							int i_42_ = (i_40_ + class312.aByte3292 - mapX - anInt3230);
							int i_43_ = (i_41_ + class312.aByte3293 - mapY - anInt3242);
			...
			for (int i_48_ = i_33_; i_48_ <= i_35_; i_48_++) {
				for (int i_49_ = i_34_; i_49_ <= i_36_; i_49_++) {
					...
					if (arraylist != null) {
						...
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							int i_52_ = (i_50_ + class312.aByte3292 - mapX - anInt3230);
							int i_53_ = (i_51_ + class312.aByte3293 - mapY - anInt3242);
	...
	public static void method3690(Js5FileSystem worldmapIndex, OverlayDefinitionLoader class375, UnderlayTypeLoader class451, ObjectDefinitionLoader class433, Class339 class339, Class487 class487, Interface23 interface23) {
		worldMapIndex = worldmapIndex;
		overlayDefinitionLoader = class375;
		...
		aClass437_3226.clear();
		int archive = worldMapIndex.getArchiveIdByName("details");
		int[] files = worldMapIndex.getFileIDs(archive);
		if (files != null) {
			for (int fileIndex = 0; fileIndex < files.length; fileIndex++) {
				Class298_Sub37_Sub13 class298_sub37_sub13 = Class469.method6048(worldMapIndex, archive, files[fileIndex]);
				aClass437_3226.connect(class298_sub37_sub13, (long) ((class298_sub37_sub13.anInt9643) * -947282109));
			}
		}
	...
	public static CircularDoubleLinkedList method3693(int i, int i_59_) {
		CircularDoubleLinkedList class461 = new CircularDoubleLinkedList();
		for (Class298_Sub37_Sub13 class298_sub37_sub13 = ((Class298_Sub37_Sub13) aClass437_3226.method5816()); class298_sub37_sub13 != null; class298_sub37_sub13 = ((Class298_Sub37_Sub13) aClass437_3226.method5815())) {
			if (class298_sub37_sub13.aBoolean9648 && class298_sub37_sub13.method3450(i, i_59_))
				class461.offer(class298_sub37_sub13);
		}
		return class461;
	}

	static int method3694(MaterialRawLoader materialRawLoader, int overlayID, int i_60_, int i_61_) {
		OverlayDefinition overlayDefinition = overlayDefinitionLoader.getOverlayDefinition(overlayID);
		if (overlayDefinition == null)
			return 0;
		int texture = overlayDefinition.texture * 324071475;
		if (texture >= 0 && materialRawLoader.method174(texture).aBoolean524)
			texture = -1;
		int i_63_;
		if (overlayDefinition.blendColor * 1728947183 >= 0) {
			int blendColor = overlayDefinition.blendColor * 1728947183;
			int i_65_ = (blendColor & 0x7f) + i_61_;
			if (i_65_ < 0)
				i_65_ = 0;
			else if (i_65_ > 127)
				i_65_ = 127;
			int i_66_ = (blendColor + i_60_ & 0xFC00) + (blendColor & 0x380) + i_65_;
			i_63_ = (~0xffffff | (Class379.anIntArray4096[Class173.method1823(StaticMethods.method4161(i_66_, 96)) & 0xFFFF]));
		} else if (texture >= 0)
			i_63_ = (~0xffffff | (Class379.anIntArray4096[Class173.method1823(StaticMethods.method4161((materialRawLoader.method174(texture).aShort532), 96)) & 0xFFFF]));
		else if (overlayDefinition.color * -45966925 == -1)
			i_63_ = 0;
		else {
			int i_67_ = overlayDefinition.color * -45966925;
			...
			i_63_ = (~0xffffff | (Class379.anIntArray4096[Class173.method1823(StaticMethods.method4161(i_69_, 96)) & 0xffff]));
		}
		return i_63_;
	}

	static void method3695(GraphicsToolkit class_ra, Buffer class298_sub53, int i, int i_70_, int i_71_, int i_72_, int[] is, int[] is_73_) {
		int i_74_ = class298_sub53.readUByte();
		if ((i_74_ & 0x1) == 0) {
			boolean bool = (i_74_ & 0x2) == 0;
			int i_75_ = i_74_ >> 2 & 0x3f;
			if (i_75_ != 62) {
				if (i_75_ == 63)
					i_75_ = class298_sub53.readUByte();
				else if (bool)
					i_75_ = is[i_75_];
				else
					i_75_ = is_73_[i_75_];
				if (bool) {
					...
					aByteArray3224[i_71_ + i_72_ * anInt3239] = class298_sub53.readByte();
				}
			}
		} else {
			...
			for (int i_78_ = 0; i_78_ < i_76_; i_78_++) {
				int i_79_ = class298_sub53.readUByte();
				int i_80_ = 0;
				int i_81_ = 0;
				if (bool) {
					i_80_ = class298_sub53.readUByte();
					i_81_ = class298_sub53.readUByte();
				}
				int i_82_ = 0;
				if (bool_77_)
					i_82_ = class298_sub53.readUByte();
				if (i_78_ == 0) {
					...
					if (i_82_ == 1) {
						anObjectArray3247[i_71_ + i_72_ * anInt3239] = new Integer(class298_sub53.readBigSmart());
						aByteArray3250[i_71_ + i_72_ * anInt3239] = class298_sub53.readByte();
					} else if (i_82_ > 1) {
						int[] is_83_ = new int[i_82_];
						byte[] is_84_ = new byte[i_82_];
						for (int i_85_ = 0; i_85_ < i_82_; i_85_++) {
							is_83_[i_85_] = class298_sub53.readBigSmart();
							is_84_[i_85_] = class298_sub53.readByte();
						}
					...
					if (i_82_ > 0) {
						...
						for (int i_88_ = 0; i_88_ < i_82_; i_88_++) {
							is_86_[i_88_] = class298_sub53.readBigSmart();
							is_87_[i_88_] = class298_sub53.readByte();
						}
					}
	...
	WorldMapHandler() throws Throwable {
		throw new Error();
	}
		...
		for (int i_97_ = -5; i_97_ < anInt3239; i_97_++) {
			...
			for (int i_100_ = 0; i_100_ < anInt3240; i_100_++) {
				if (i_98_ < anInt3239) {
					...
					if (i_101_ > 0) {
						UnderlayType underlayType = aClass451_3219.load(i_101_ - 1);
						is_92_[i_100_] += underlayType.hue * 838046775;
						is_93_[i_100_] += underlayType.saturation * -620399085;
						is_94_[i_100_] += underlayType.lightness * 656695887;
						is_95_[i_100_] += underlayType.chroma * -813159285;
						is_96_[i_100_]++;
					}
				}
				if (i_99_ >= 0) {
					...
					if (i_102_ > 0) {
						UnderlayType underlayType = aClass451_3219.load(i_102_ - 1);
						is_92_[i_100_] -= underlayType.hue * 838046775;
						is_93_[i_100_] -= underlayType.saturation * -620399085;
						is_94_[i_100_] -= underlayType.lightness * 656695887;
						is_95_[i_100_] -= underlayType.chroma * -813159285;
				...
				for (int i_108_ = -5; i_108_ < anInt3240; i_108_++) {
					...
					if (i_108_ >= 0 && i_107_ > 0) {
						if ((is[i_97_ + i_108_ * anInt3239] & 0xff) == 0) {
							...
							int i_116_ = (Class379.anIntArray4096[(Class173.method1823(Class290.method2749(i_114_, 96, 1291456097))) & 0xffff]);
	...
	static void method3697() {
		...
		for (int i = 0; i < aClass296_3235.anInt3169 * -1407078377; i++) {
			boolean bool = (aClass298_Sub37_Sub13_3218.method3453(aClass296_3235.anIntArray3168[i] >> 28 & 0x3, aClass296_3235.anIntArray3168[i] >> 14 & 0x3fff, aClass296_3235.anIntArray3168[i] & 0x3fff, is));
			if (bool) {
				...
				aClass453_3236.pushBack(class298_sub52);
			}
		}
	}
	...
	static void openingMapInterface(GraphicsToolkit graphicsToolkit, int i, int i_120_) {
		Buffer buffer = new Buffer(worldMapIndex.getFile(aClass298_Sub37_Sub13_3218.locationName, "area"));
		int count = buffer.readUByte();
		int[] data = new int[count];
		for (int pos = 0; pos < count; pos++)
			data[pos] = buffer.readUByte();
		int count2 = buffer.readUByte();
		int[] data2 = new int[count2];
		for (int pos = 0; pos < count2; pos++)
			data2[pos] = buffer.readUByte();
		while (buffer.offset * 385051775 < buffer.buffer.length) {
			if (buffer.readUByte() == 0) {
				int regionX = buffer.readUByte();
				int regionY = buffer.readUByte();
				for (int x = 0; x < 64; x++) {
					for (int y = 0; y < 64; y++) {
						int localX = regionX * 64 + x - mapX;
						int localY = regionY * 64 + y - mapY;
						method3695(graphicsToolkit, buffer, regionX, regionY, localX, localY, data, data2);
					}
				}
			} else {
				int regionX = buffer.readUByte();
	...
	static void method3700(GraphicsToolkit class_ra, int i, int i_147_, int i_148_, int i_149_, int i_150_, int i_151_, int i_152_, int[] is, byte[] is_153_, boolean bool) {
		if (bool || i_150_ != 0 || i_151_ > 0) {
			if (i_151_ == 0)
				class_ra.drawFilledRectangle(i, i_147_, i_148_, i_149_, i_150_, 0);
			else {
				int i_154_ = i_152_ & 0x3f;
				if (i_154_ == 0 || i_148_ <= 1 || i_149_ <= 1) {
					int i_155_ = overlayCacheFiles[i_151_];
					if (bool || i_155_ != 0)
						class_ra.drawFilledRectangle(i, i_147_, i_148_, i_149_, i_155_, 0);
				} else {
					int i_156_ = bool ? 0 : 1;
					Class252.method2409(class_ra, aByteArrayArrayArray3229, anInt3254, i, i_147_, i_150_, overlayCacheFiles[i_151_], i_148_, i_149_, i_154_, i_152_ >> 6 & 0x3, i_156_, (byte) 127);
				}
			}
		}
		if (is != null) {
			...
			for (int i_159_ = 0; i_159_ < is.length; i_159_++) {
				...
				if (i_160_ == Class424.aClass424_6614.type * -1976050083 || (i_160_ == Class424.aClass424_6593.type * -1976050083) || (i_160_ == Class424.aClass424_6594.type * -1976050083) || (i_160_ == Class424.aClass424_6595.type * -1976050083)) {
					ObjectDefinition class432 = aClass433_3220.get(is[i_159_]);
					if (class432.anInt5400 * -1204256389 == -1) {
						int i_161_ = -3355444;
						if (class432.anInt5382 * 1532834983 == 1)
							i_161_ = -3407872;
						int i_162_ = is_153_[i_159_] >> 6 & 0x3;
						if (i_160_ == (Class424.aClass424_6614.type * -1976050083)) {
							if (i_162_ == 0)
						...
						} else if (i_160_ == (Class424.aClass424_6593.type * -1976050083)) {
							if (i_162_ == 0) {
						...
						} else if (i_160_ == (Class424.aClass424_6594.type * -1976050083)) {
							if (i_162_ == 0)
						...
						} else if (i_160_ == (Class424.aClass424_6595.type * -1976050083)) {
	...
	static void method3701(GraphicsToolkit class_ra, int i, int i_165_, int i_166_, int i_167_, int[] is, byte[] is_168_) {
		if (is != null) {
			for (int i_169_ = 0; i_169_ < is.length; i_169_++) {
				ObjectDefinition class432 = aClass433_3220.get(is[i_169_]);
				int i_170_ = class432.anInt5400 * -1204256389;
				if (i_170_ != -1) {
					Class496 class496 = aClass487_3225.method6159(i_170_);
					SpriteToolkit class57 = class496.method6198(class_ra, (class432.aBoolean5401 ? is_168_[i_169_] >> 6 & 0x3 : 0), (class432.aBoolean5440 && class432.aBoolean5404));
					if (class57 != null) {
						int i_171_ = i_166_ * class57.getPaddedWidth() >> 2;
						int i_172_ = i_167_ * class57.getPaddedHeight() >> 2;
						...
						if (i_171_ != 0 && i_172_ != 0) {
							if (class496.anInt6096 * -2012904123 != 0)
								class57.method691(i, i_165_ - i_172_ + i_167_, i_171_, i_172_, 0, (~0xffffff | (class496.anInt6096 * -2012904123)), 1);
							else
								class57.drawScaled(i, i_165_ - i_172_ + i_167_, i_171_, i_172_);
						}
					}
				}
			}
	...
	static Class453 method3703(GraphicsToolkit class_ra, int i, int i_179_, int i_180_, int i_181_) {
		for (Class298_Sub52 class298_sub52 = (Class298_Sub52) aClass453_3236.method5939(); class298_sub52 != null; class298_sub52 = (Class298_Sub52) aClass453_3236.method5944())
	...
	static void method3706() {
		...
		overlayCacheFiles = new int[overlayDefinitionLoader.filesCount * 138682397 + 1];
	}

	static void method3707(MaterialRawLoader interface_ma, int i, int i_185_) {
		for (int fileID = 0; fileID < overlayDefinitionLoader.filesCount * 138682397; fileID++)
			overlayCacheFiles[fileID + 1] = method3694(interface_ma, fileID, i, i_185_);
	}

	public static Class298_Sub37_Sub13 method3708(int i, int i_187_) {
		for (Class298_Sub37_Sub13 class298_sub37_sub13 = ((Class298_Sub37_Sub13) aClass437_3226.method5816()); class298_sub37_sub13 != null; class298_sub37_sub13 = ((Class298_Sub37_Sub13) aClass437_3226.method5815())) {
			if (class298_sub37_sub13.aBoolean9648 && class298_sub37_sub13.method3450(i, i_187_))
					...
					if (object instanceof Class298_Sub54) {
						...
						if (class298_sub54 != null) {
							for (int i_196_ = 0; i_196_ < (class298_sub54.anIntArray7621).length; i_196_++) {
								ObjectDefinition class432 = (aClass433_3220.get((class298_sub54.anIntArray7621[i_196_])));
								int i_197_ = class432.anInt5399 * -1422593103;
								if (class432.objectIDs != null) {
									class432 = (class432.method5777(anInterface23_3223));
									if (class432 != null)
						...
						Integer integer = (Integer) object;
						ObjectDefinition class432 = aClass433_3220.get(integer.intValue());
						...
						while (iterator.hasNext()) {
							...
							if (class312.anIntArray3288 != null) {
								for (int i_201_ = 0; i_201_ < (class312.anIntArray3288).length; i_201_++) {
									ObjectDefinition class432 = (aClass433_3220.get((class312.anIntArray3288[i_201_])));
									...
									if (i_202_ != -1) {
										...
										class298_sub52.anInt7607 = ((i_199_ + (mapX >> 6)) * 64 + (class312.aByte3292) - mapX) * 898378357;
										class298_sub52.anInt7610 = ((i_200_ + (mapY >> 6)) * 64 + (class312.aByte3293) - mapY) * -1686044477;
										aClass453_3236.pushBack(class298_sub52);
									}
								}
							}
		...
		if (class352.anIntArray3803 != null) {
			...
			if (class352.anInt3806 * -972644285 > 0) {
				for (int i = 0; i < is.length / 2 - 1; i++) {
					...
					class_ra.drawDashedLine(i_205_, i_206_, i_207_, i_208_, (class352.anIntArray3814[class352.aByteArray3777[i] & 0xff]), 1, class352.anInt3806 * -972644285, class352.anInt3799 * 2123190239, class352.anInt3788 * -176015499);
				}
				...
				class_ra.drawDashedLine(i, i_212_, i_213_, i_214_, (class352.anIntArray3814[((class352.aByteArray3777[class352.aByteArray3777.length - 1]) & 0xff)]), 1, class352.anInt3806 * -972644285, class352.anInt3799 * 2123190239, class352.anInt3788 * -176015499);
			} else {
				for (int i = 0; i < is.length / 2 - 1; i++)
					class_ra.drawDiagnolLine(is[i * 2], is[i * 2 + 1], is[(i + 1) * 2], is[(i + 1) * 2 + 1], (class352.anIntArray3814[class352.aByteArray3777[i] & 0xff]));
				class_ra.drawDiagnolLine(is[is.length - 2], is[is.length - 1], is[0], is[1], (class352.anIntArray3814[((class352.aByteArray3777[class352.aByteArray3777.length - 1]) & 0xff)]));
			}
		}
	}
}
