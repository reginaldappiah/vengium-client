package com.jagex;/* Class40 - Decompiled by JODE
...
public abstract class Class40 {
	...
	int anInt436;
	OpenGLGraphicsToolkit aClass_ra_Sub2_437;
	boolean aBoolean438;
	boolean aBoolean439 = false;
	static int[] anIntArray440 = new int[1];

	Class40(OpenGLGraphicsToolkit class_ra_sub2, int i, Buffer buffer, int i_0_, boolean bool) {
	...
	Class40(OpenGLGraphicsToolkit class_ra_sub2, int i, byte[] is, int i_1_, boolean bool) {
		this.aClass_ra_Sub2_437 = class_ra_sub2;
		this.anInt433 = i;
		this.anInt432 = i_1_;
		this.aBoolean438 = bool;
