package com.jagex;/* Class159 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class159 {
	static int anInt1617 = 128;
	NativeToolkit aClass_ra_Sub3_1618;
	...
	Class159(NativeToolkit class_ra_sub3) {
	...
	public boolean method1705() {
		...
		if (anInterface9_Impl3_1626 == null) {
			if (anObject1629 == null) {
				...
				anObject1629 = Js5FileSystem.packArray(is, false);
			}
			byte[] is = Class338.unwrapBuffer(anObject1629, false);
	...
	static void method1706() {
		if (anObject1622 == null) {
			...
			anObject1622 = Js5FileSystem.packArray(is, false);
		}
		if (anObject1628 == null) {
			...
			anObject1628 = Js5FileSystem.packArray(is, false);
		}
	}
}
