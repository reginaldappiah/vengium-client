package com.jagex;/* Class298_Sub32_Sub7 - Decompiled by JODE
...
public class Class298_Sub32_Sub7 extends Class298_Sub32 {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("agt.i(").append(')').toString());
		}
	}
