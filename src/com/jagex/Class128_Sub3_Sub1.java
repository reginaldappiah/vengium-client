package com.jagex;/* Class128_Sub3_Sub1 - Decompiled by JODE
...
public class Class128_Sub3_Sub1 extends Class128_Sub3 {
	...
	public Class146 method49(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("afr.f(").append(')').toString());
		}
	}
