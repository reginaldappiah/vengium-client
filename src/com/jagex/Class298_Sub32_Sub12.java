package com.jagex;/* Class298_Sub32_Sub12 - Decompiled by JODE
...
public class Class298_Sub32_Sub12 extends Class298_Sub32 {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aha.i(").append(')').toString());
		}
	}
}
