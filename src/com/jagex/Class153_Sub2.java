package com.jagex;/* Class153_Sub2 - Decompiled by JODE
...
public class Class153_Sub2 extends Class153 {
	long aLong8623 = 0L;
	DirectXGraphicsToolkit aDirectXJavaGraphicsToolkit_8624;
	...
	public void b() {
		...
		this.aDirectXJavaGraphicsToolkit_8624.method5293(this);
	}

	void method1658() {
		if (this.aLong8623 != 0L) {
			this.aDirectXJavaGraphicsToolkit_8624.method5552(this.aLong8623);
			this.aLong8623 = 0L;
		}
	}
	...
	Class153_Sub2(DirectXGraphicsToolkit directXJavaGraphicsToolkit, Class181[] class181s) {
		super(class181s);
		this.aDirectXJavaGraphicsToolkit_8624 = directXJavaGraphicsToolkit;
		byte i = 0;
		ByteBuffer bytebuffer = this.aDirectXJavaGraphicsToolkit_8624.aByteBuffer8216;
		bytebuffer.clear();
		...
		this.aLong8623 = (IDirect3DDevice.CreateVertexDeclaration(this.aDirectXJavaGraphicsToolkit_8624.aLong9847, this.aDirectXJavaGraphicsToolkit_8624.aLong8217));
		this.aDirectXJavaGraphicsToolkit_8624.method5323(this);
	}
}
