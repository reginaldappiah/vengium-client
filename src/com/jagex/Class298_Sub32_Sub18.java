package com.jagex;/* Class298_Sub32_Sub18 - Decompiled by JODE
...
public class Class298_Sub32_Sub18 extends Class298_Sub32 {
	...
	void method3243(int i, Buffer class298_sub53) {
		switch (i) {
		case 3:
			this.anInt9442 = class298_sub53.readUByte() * -190415455;
			break;
		case 0:
			this.anInt9434 = class298_sub53.readUByte() * 56159889;
			break;
		case 1:
			this.anInt9441 = class298_sub53.readUByte() * -518479681;
			break;
		}
	}
	...
	void method3137(int i, Buffer buffer) {
		try {
			switch (i) {
			case 3:
				this.anInt9442 = buffer.readUByte() * -190415455;
				break;
			case 0:
				this.anInt9434 = buffer.readUByte() * 56159889;
				break;
			case 1:
				this.anInt9441 = buffer.readUByte() * -518479681;
				break;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahg.r(").append(')').toString());
		}
	}
	...
	void method3133(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahg.posX(").append(')').toString());
		}
	}

	void method3244(int i, Buffer class298_sub53) {
		switch (i) {
		case 3:
			this.anInt9442 = class298_sub53.readUByte() * -190415455;
			break;
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_3_ = 0; i_3_ < Class250.anInt2755 * -1474554145; i_3_++) {
				...
				if (716214897 * this.anInt9434 == 0)
					...
					i_6_ = (int) ((double) (i_6_ * ((this.anInt9442) * 1525982817)) * 3.141592653589793);
				}
				i_6_ -= i_6_ & ~0xfff;
	...
	int[] method3131(int i, int i_8_) {
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				...
				for (int i_11_ = 0; i_11_ < Class250.anInt2755 * -1474554145; i_11_++) {
					...
					if (716214897 * this.anInt9434 == 0)
						...
						i_14_ = (int) ((double) (i_14_ * (this.anInt9442 * 1525982817)) * 3.141592653589793);
					}
					i_14_ -= i_14_ & ~0xfff;
					if (0 == (this.anInt9441 * 1988808511))
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahg.i(").append(')').toString());
		}
	}
		...
		if (aClass257_7384.aBoolean2810) {
			...
			for (int i_18_ = 0; i_18_ < Class250.anInt2755 * -1474554145; i_18_++) {
				...
				if (716214897 * this.anInt9434 == 0)
					...
					i_21_ = (int) ((double) (i_21_ * ((this.anInt9442) * 1525982817)) * 3.141592653589793);
				}
				i_21_ -= i_21_ & ~0xfff;
				if (0 == this.anInt9441 * 1988808511)
