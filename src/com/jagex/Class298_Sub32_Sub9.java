package com.jagex;/* Class298_Sub32_Sub9 - Decompiled by JODE
...
public class Class298_Sub32_Sub9 extends Class298_Sub32 {
	...
	int[] method3189(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			int[] is_0_ = method3129(0, (this.aBoolean9389 ? -289063255 * Class250.anInt2758 - i : i));
	...
	int[][] method3190(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int[][] is_2_ = method3134(0, (this.aBoolean9389 ? Class250.anInt2758 * -289063255 - i : i));
			int[] is_3_ = is_2_[0];
			int[] is_4_ = is_2_[1];
			int[] is_5_ = is_2_[2];
			int[] is_6_ = is[0];
	...
	int[] method3131(int i, int i_11_) {
		try {
			int[] is = aClass257_7384.method2448(i);
			if (aClass257_7384.aBoolean2810) {
				int[] is_12_ = method3129(0, (this.aBoolean9389 ? -289063255 * Class250.anInt2758 - i : i));
				if (this.aBoolean9388) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("agw.i(").append(')').toString());
		}
	}

	void method3191(int i, Buffer class298_sub53) {
		switch (i) {
		case 2:
			aBoolean7382 = class298_sub53.readUByte() == 1;
			break;
		case 0:
			this.aBoolean9388 = class298_sub53.readUByte() == 1;
			break;
		case 1:
			this.aBoolean9389 = class298_sub53.readUByte() == 1;
			break;
		}
	}
	...
	int[] method3192(int i) {
		int[] is = aClass257_7384.method2448(i);
		if (aClass257_7384.aBoolean2810) {
			int[] is_14_ = method3129(0, (this.aBoolean9389 ? -289063255 * Class250.anInt2758 - i : i));
			if (this.aBoolean9388) {
	...
	void method3137(int i, Buffer buffer) {
		try {
			...
			case 2:
				...
				break;
			case 0:
				this.aBoolean9388 = buffer.readUByte() == 1;
				break;
			case 1:
				this.aBoolean9389 = buffer.readUByte() == 1;
				break;
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("agw.r(").append(')').toString());
		}
	}

	void method3193(int i, Buffer class298_sub53) {
		switch (i) {
		case 2:
			aBoolean7382 = class298_sub53.readUByte() == 1;
			break;
	...
	int[][] method3132(int i) {
		try {
			int[][] is = aClass239_7380.method2205(i);
			if (aClass239_7380.aBoolean2607) {
				int[][] is_18_ = method3134(0, (this.aBoolean9389 ? Class250.anInt2758 * -289063255 - i : i));
				int[] is_19_ = is_18_[0];
				int[] is_20_ = is_18_[1];
				int[] is_21_ = is_18_[2];
				int[] is_22_ = is[0];
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("agw.k(").append(')').toString());
		}
	}
	...
	int[][] method3194(int i) {
		int[][] is = aClass239_7380.method2205(i);
		if (aClass239_7380.aBoolean2607) {
			int[][] is_27_ = method3134(0, (this.aBoolean9389 ? Class250.anInt2758 * -289063255 - i : i));
			int[] is_28_ = is_27_[0];
			int[] is_29_ = is_27_[1];
			int[] is_30_ = is_27_[2];
			int[] is_31_ = is[0];
