package com.jagex;/* Class298_Sub32_Sub25 - Decompiled by JODE
...
public class Class298_Sub32_Sub25 extends Class298_Sub32 {
		...
		try {
			...
			if (aClass257_7384.aBoolean2810) {
				for (int i_1_ = 0; i_1_ < Class250.anInt2755 * -1474554145; i_1_++) {
					...
					int[] is_2_ = method3129(0, anInt9481 * -927323081);
					is[i_1_] = is_2_[anInt9479 * 47038181];
				}
			}
			return is;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahn.i(").append(')').toString());
		}
	}
	...
	void method3137(int i, Buffer buffer) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahn.r(").append(')').toString());
		}
	}
	...
	int[][] method3294(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_7_ = 0; i_7_ < -1474554145 * Class250.anInt2755; i_7_++) {
				...
				int[][] is_8_ = method3134(0, anInt9481 * -927323081);
	...
	int[] method3295(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			for (int i_9_ = 0; i_9_ < Class250.anInt2755 * -1474554145; i_9_++) {
				...
				int[] is_10_ = method3129(0, anInt9481 * -927323081);
	...
	int[] method3296(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			for (int i_11_ = 0; i_11_ < Class250.anInt2755 * -1474554145; i_11_++) {
				...
				int[] is_12_ = method3129(0, anInt9481 * -927323081);
	...
	void method3297(int i, Buffer class298_sub53) {
		if (0 == i)
			aBoolean7382 = class298_sub53.readUByte() == 1;
	}

	void method3298(int i, Buffer class298_sub53) {
		if (0 == i)
			aBoolean7382 = class298_sub53.readUByte() == 1;
	}
	...
	final void method3299(int i, int i_13_, int i_14_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahn.ac(").append(')').toString());
		}
	}
	...
	int[][] method3300(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			...
			for (int i_20_ = 0; i_20_ < -1474554145 * Class250.anInt2755; i_20_++) {
				...
				int[][] is_21_ = method3134(0, anInt9481 * -927323081);
		...
		try {
			...
			if (aClass239_7380.aBoolean2607) {
				...
				for (int i_26_ = 0; i_26_ < -1474554145 * Class250.anInt2755; i_26_++) {
					...
					int[][] is_27_ = method3134(0, anInt9481 * -927323081);
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahn.k(").append(')').toString());
		}
	}
}
