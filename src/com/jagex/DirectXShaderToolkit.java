package com.jagex;/* DirectXShaderToolkit - Decompiled by JODE
...
public final class DirectXShaderToolkit extends ShaderProgramToolkit {
	static float[] aFloatArray8591 = new float[16];
	long aLong8592;
	DirectXGraphicsToolkit aDirectXJavaGraphicsToolkit_8593;
	...
	DirectXShaderToolkit(DirectXGraphicsToolkit directXJavaGraphicsToolkit, Class108 class108) {
		this.aBooleanArray8594 = new boolean[2];
		programName = class108.programName;
		if (class108.aString1316 != null) {
			aString6400 = class108.aString1316;
			this.aByteArray8595 = directXJavaGraphicsToolkit.method5549(aString6400);
		}
		if (class108.aString1318 != null) {
			aString6401 = class108.aString1318;
			this.aByteArray8598 = directXJavaGraphicsToolkit.method5549(aString6401);
		}
		directXJavaGraphicsToolkit.method5323(this);
	}

	void method1183(ShaderProgram class298_sub31_sub1, float f) {
	...
	void method1176(ShaderProgram class298_sub31_sub1, float f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1161(ShaderProgram class298_sub31_sub1, float f, float f_6_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1228() {
		if (this.aLong8597 != 0L) {
			this.aDirectXJavaGraphicsToolkit_8593.method5552(this.aLong8597);
			this.aLong8597 = 0L;
		}
		if (this.aLong8592 != 0L) {
			this.aDirectXJavaGraphicsToolkit_8593.method5552(this.aLong8592);
			this.aLong8592 = 0L;
		}
	}

	void method1192(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (class298_sub31_sub1.method3118(1027907149) != Class100.aClass100_963)
			throw new IllegalArgumentException_Sub1(class298_sub31_sub1, "");
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_8_ >= 0)
			method1230(i_8_, matrix4f.method2150(aFloatArray8591), 8);
	}

	void method1174(int i, int i_9_, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i_9_);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}

	void method1166(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (class298_sub31_sub1.method3118(974168980) != Class100.aClass100_996)
			throw new IllegalArgumentException_Sub1(class298_sub31_sub1, "");
		if (i >= 0)
			method1231(i, matrix4f.method2161(aFloatArray8591), 16);
		if (i_10_ >= 0)
			method1230(i_10_, matrix4f.method2161(aFloatArray8591), 16);
	}

	void method1164(ShaderProgram class298_sub31_sub1, float[] fs, int i) {
	...
	void method1167(ShaderProgram class298_sub31_sub1, int i, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}
	...
	DirectXShaderToolkit(DirectXGraphicsToolkit directXJavaGraphicsToolkit, Class123_Sub1 class123_sub1, Class108 class108) {
		this(directXJavaGraphicsToolkit, class108);
		this.aDirectXJavaGraphicsToolkit_8593 = directXJavaGraphicsToolkit;
		this.aClass123_Sub1_8602 = class123_sub1;
	}

	void method1159(int i, Matrix4f matrix4f) {
		int i_22_ = i >> 16;
		int i_23_ = (i & 0xffff) * 4;
		System.arraycopy(matrix4f.method2150(aFloatArray8591), 0, this.aFloatArrayArray8601[i_22_], i_23_, 8);
		this.aBooleanArray8594[i_22_] = true;
	}

	void method1173(int i, Matrix4f matrix4f) {
		int i_24_ = i >> 16;
		int i_25_ = (i & 0xffff) * 4;
		System.arraycopy(matrix4f.method2161(aFloatArray8591), 0, this.aFloatArrayArray8601[i_24_], i_25_, 16);
	...
	void method1229() {
		if (this.aBooleanArray8594[0]) {
			for (int i = 0; i < this.aFloatArrayArray8601[0].length; i++)
				this.aDirectXJavaGraphicsToolkit_8593.anUnsafe8219.putFloat((this.aDirectXJavaGraphicsToolkit_8593.aLong8217 + (long) (i * 4)), this.aFloatArrayArray8601[0][i]);
			IDirect3DDevice.SetVertexShaderConstantF(this.aDirectXJavaGraphicsToolkit_8593.aLong9847, 0, this.aDirectXJavaGraphicsToolkit_8593.aLong8217, this.aFloatArrayArray8601[0].length / 4);
			this.aBooleanArray8594[0] = false;
		}
		if (this.aBooleanArray8594[1]) {
			for (int i = 0; i < this.aFloatArrayArray8601[1].length; i++)
				this.aDirectXJavaGraphicsToolkit_8593.anUnsafe8219.putFloat((this.aDirectXJavaGraphicsToolkit_8593.aLong8217 + (long) (i * 4)), this.aFloatArrayArray8601[1][i]);
			IDirect3DDevice.SetPixelShaderConstantF(this.aDirectXJavaGraphicsToolkit_8593.aLong9847, 0, this.aDirectXJavaGraphicsToolkit_8593.aLong8217, this.aFloatArrayArray8601[1].length / 4);
			this.aBooleanArray8594[1] = false;
		}
	}

	void method1187(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2161(aFloatArray8591), 16);
		if (i_26_ >= 0)
			method1230(i_26_, matrix4f.method2161(aFloatArray8591), 16);
	}
	...
	public void b() {
		...
		this.aDirectXJavaGraphicsToolkit_8593.method5293(this);
	}
	...
	void method1197(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_28_ >= 0)
			method1230(i_28_, matrix4f.method2150(aFloatArray8591), 8);
	}
	...
	void method1177(ShaderProgram class298_sub31_sub1, float[] fs, int i) {
	...
	void method1194(ShaderProgram class298_sub31_sub1, float f, float f_34_, float f_35_, float f_36_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	public boolean method1209() {
		if (this.aBoolean8596)
			return true;
		this.aLong8597 = (this.aByteArray8595 == null ? 0L : (IDirect3DDevice.CreateVertexShader(this.aDirectXJavaGraphicsToolkit_8593.aLong9847, this.aByteArray8595)));
		this.aLong8592 = (this.aByteArray8598 == null ? 0L : (IDirect3DDevice.CreatePixelShader(this.aDirectXJavaGraphicsToolkit_8593.aLong9847, this.aByteArray8598)));
		if (this.aLong8597 == 0L && this.aLong8592 == 0L)
			return false;
		int i = -1;
		for (int i_38_ = 0; i_38_ < this.aClass123_Sub1_8602.method1328(); i_38_++) {
		...
		for (int i_41_ = 0; i_41_ < i_39_; i_41_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub1_8602.method1352(i_41_, 444661617);
			class298_sub31_sub1.method3124(i);
		}
		for (int i_42_ = 0; i_42_ < i_40_; i_42_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub1_8602.method1370(i_42_, 1888215794);
			class298_sub31_sub1.method3124(i);
		}
		int i_43_ = 0;
		int i_44_ = 0;
	...
	public boolean method1180() {
		...
		if (this.aLong8597 == 0L && this.aLong8592 == 0L)
			return false;
		int i = -1;
		for (int i_50_ = 0; i_50_ < this.aClass123_Sub1_8602.method1328(); i_50_++) {
		...
		for (int i_53_ = 0; i_53_ < i_51_; i_53_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub1_8602.method1352(i_53_, 444661617);
			class298_sub31_sub1.method3124(i);
		}
		for (int i_54_ = 0; i_54_ < i_52_; i_54_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub1_8602.method1370(i_54_, 1888215794);
			class298_sub31_sub1.method3124(i);
		}
		int i_55_ = 0;
		int i_56_ = 0;
	...
	void method1181(ShaderProgram class298_sub31_sub1, float f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1205(ShaderProgram class298_sub31_sub1, float f, float f_63_, float f_64_, float f_65_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1207(ShaderProgram class298_sub31_sub1, float f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1191(ShaderProgram class298_sub31_sub1, float f, float f_72_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1185(ShaderProgram class298_sub31_sub1, float f, float f_74_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1186(ShaderProgram class298_sub31_sub1, float f, float f_76_, float f_77_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1188(ShaderProgram class298_sub31_sub1, float f, float f_79_, float f_80_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1179(ShaderProgram class298_sub31_sub1, float f, float f_82_, float f_83_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1208(ShaderProgram class298_sub31_sub1, int i, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}

	void method1165(ShaderProgram class298_sub31_sub1, float f, float f_85_, float f_86_, float f_87_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1178(ShaderProgram class298_sub31_sub1, float f, float f_89_, float f_90_, float f_91_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1193(ShaderProgram class298_sub31_sub1, float f, float f_93_, float f_94_, float f_95_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1199(int i, int i_97_, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i_97_);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}
	...
	void method1196(ShaderProgram class298_sub31_sub1, float[] fs, int i) {
	...
	void method1190(ShaderProgram class298_sub31_sub1, float f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1215(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_105_ >= 0)
			method1230(i_105_, matrix4f.method2150(aFloatArray8591), 8);
	}

	void method1200(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_106_ >= 0)
			method1230(i_106_, matrix4f.method2150(aFloatArray8591), 8);
	}

	void method1216(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_107_ >= 0)
			method1230(i_107_, matrix4f.method2150(aFloatArray8591), 8);
	}

	void glColor3f(ShaderProgram class298_sub31_sub1, float f, float f_108_, float f_109_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	void method1171(int i, Matrix4f matrix4f) {
		int i_111_ = i >> 16;
		int i_112_ = (i & 0xffff) * 4;
		System.arraycopy(matrix4f.method2161(aFloatArray8591), 0, this.aFloatArrayArray8601[i_111_], i_112_, 12);
		this.aBooleanArray8594[i_111_] = true;
	}

	void method1203(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2161(aFloatArray8591), 16);
		if (i_113_ >= 0)
			method1230(i_113_, matrix4f.method2161(aFloatArray8591), 16);
	}

	void method1204(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2161(aFloatArray8591), 16);
		if (i_114_ >= 0)
			method1230(i_114_, matrix4f.method2161(aFloatArray8591), 16);
	}

	void method1198(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_115_ >= 0)
			method1230(i_115_, matrix4f.method2150(aFloatArray8591), 8);
	}

	void method1184(ShaderProgram class298_sub31_sub1, int i, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}

	void method1212(ShaderProgram class298_sub31_sub1, int i, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}
	...
	void method1189(ShaderProgram class298_sub31_sub1, float f, float f_129_, float f_130_, float f_131_) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
	...
	public boolean method1221() {
		...
		if (this.aLong8597 == 0L && this.aLong8592 == 0L)
			return false;
		int i = -1;
		for (int i_133_ = 0; i_133_ < this.aClass123_Sub1_8602.method1328(); i_133_++) {
		...
		for (int i_136_ = 0; i_136_ < i_134_; i_136_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub1_8602.method1352(i_136_, 444661617);
			class298_sub31_sub1.method3124(i);
		}
		for (int i_137_ = 0; i_137_ < i_135_; i_137_++) {
			ShaderProgram class298_sub31_sub1 = this.aClass123_Sub1_8602.method1370(i_137_, 1888215794);
			class298_sub31_sub1.method3124(i);
		}
		int i_138_ = 0;
		int i_139_ = 0;
	...
	void method1202(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_145_ >= 0)
			method1230(i_145_, matrix4f.method2150(aFloatArray8591), 8);
	}
	...
	void method1172(int i, Matrix4f matrix4f) {
		int i_152_ = i >> 16;
		int i_153_ = (i & 0xffff) * 4;
		System.arraycopy(matrix4f.method2161(aFloatArray8591), 0, this.aFloatArrayArray8601[i_152_], i_153_, 12);
		this.aBooleanArray8594[i_152_] = true;
	}

	void method1175(int i, Matrix4f matrix4f) {
		int i_154_ = i >> 16;
		int i_155_ = (i & 0xffff) * 4;
		System.arraycopy(matrix4f.method2150(aFloatArray8591), 0, this.aFloatArrayArray8601[i_154_], i_155_, 8);
		this.aBooleanArray8594[i_154_] = true;
	}

	void method1217(int i, Matrix4f matrix4f) {
		int i_156_ = i >> 16;
		int i_157_ = (i & 0xffff) * 4;
		System.arraycopy(matrix4f.method2161(aFloatArray8591), 0, this.aFloatArrayArray8601[i_156_], i_157_, 16);
		this.aBooleanArray8594[i_156_] = true;
	}

	void method1218(int i, int i_158_, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i_158_);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}

	void method1158(int i, int i_159_, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i_159_);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}

	void method1201(ShaderProgram class298_sub31_sub1, Matrix4f matrix4f) {
		int i = ((Class298_Sub31_Sub1_Sub2) class298_sub31_sub1).method3127();
		...
		if (i >= 0)
			method1231(i, matrix4f.method2150(aFloatArray8591), 8);
		if (i_160_ >= 0)
			method1230(i_160_, matrix4f.method2150(aFloatArray8591), 8);
	}
	...
	void method1220(int i, int i_166_, Interface9 interface9) {
		this.aDirectXJavaGraphicsToolkit_8593.method5357(i_166_);
		this.aDirectXJavaGraphicsToolkit_8593.method5358(interface9);
	}

	void glColor4f(ShaderProgram program, float f, float f_167_, float f_168_, float f_169_) {
		int i = ((Class298_Sub31_Sub1_Sub2) program).method3127();
		int i_170_ = ((Class298_Sub31_Sub1_Sub2) program).method3126();
		if (program.method3118(-895076841) != Class100.aClass100_1001)
			throw new IllegalArgumentException_Sub1(program, "");
		if (i >= 0) {
			i *= 4;
			this.aFloatArrayArray8601[0][i + 0] = f;
