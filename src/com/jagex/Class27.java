package com.jagex;/* Class27 - Decompiled by JODE
...
public class Class27 {
	...
	void method401(int i, int i_0_, int i_1_, boolean bool, boolean bool_2_) {
		bool_2_ &= this.openGLGraphicsToolkit.method5224();
	...
	Class27(OpenGLGraphicsToolkit openGLGraphicsToolkit) {
		this.openGLGraphicsToolkit = openGLGraphicsToolkit;
		this.aClass45_362 = new Class45(openGLGraphicsToolkit);
		this.aClass47Array363 = new Class47[16];
		this.aClass47Array363[1] = new Class47_Sub3(openGLGraphicsToolkit);
		this.aClass47Array363[2] = new Class47_Sub8(openGLGraphicsToolkit, this.aClass45_362);
		this.aClass47Array363[4] = new Class47_Sub4(openGLGraphicsToolkit, this.aClass45_362);
		this.aClass47Array363[5] = new Class47_Sub6(openGLGraphicsToolkit, this.aClass45_362);
		this.aClass47Array363[6] = new Class47_Sub1(openGLGraphicsToolkit);
		this.aClass47Array363[7] = new Class47_Sub7(openGLGraphicsToolkit);
		this.aClass47Array363[3] = this.aClass47_Sub5_358 = new Class47_Sub5(openGLGraphicsToolkit);
		this.aClass47Array363[8] = new Class47_Sub9(openGLGraphicsToolkit, this.aClass45_362);
		this.aClass47Array363[9] = new Class47_Sub2(openGLGraphicsToolkit, this.aClass45_362);
