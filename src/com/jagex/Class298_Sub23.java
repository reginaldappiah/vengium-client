package com.jagex;/* Class298_Sub23 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class298_Sub23 extends Node {
	...
	void decode(byte[] data) {
		...
		this.anInt7318 = buffer.readInt();
		this.anInt7335 = buffer.readInt();
		this.anInt7320 = buffer.readInt();
		this.anInt7321 = buffer.readInt();
		if (this.anInt7321 < 0) {
			this.anInt7321 = this.anInt7321 ^ 0xffffffff;
			this.aBoolean7336 = true;
		}
		int length = buffer.readInt();
		this.aByteArrayArray7347 = new byte[length][];
		for (int index = 0; index < length; index++) {
			int size = 0;
			int offset;
			do {
				offset = buffer.readUByte();
				size += offset;
			} while (offset >= 255);
			byte[] newData = new byte[size];
			buffer.readBytes(newData, 0, size);
			this.aByteArrayArray7347[index] = newData;
		}
	}
	...
	static boolean method3064(Js5FileSystem class243) {
		if (!aBoolean7334) {
			byte[] data = class243.getFileFromArchive(0, 0);
			if (data == null)
				return false;
			method3069(data);
		}
	...
	static Class298_Sub23 method3065(Js5FileSystem class243, int type, int fileID) {
		if (!method3064(class243)) {
			class243.fileExists(type, fileID);
			return null;
		}
		byte[] data = class243.getFileFromArchive(type, fileID);
		if (data == null)
			return null;
		return new Class298_Sub23(data);
	}

	public static Class298_Sub23 method3066(Js5FileSystem fileSystem, int fileID) {
		if (!method3064(fileSystem)) {
			fileSystem.exists(fileID);
			return null;
		}
	...
	static void method3069(byte[] is) {
		...
		for (int i = 0; i < 2; i++) {
			...
			int i_22_ = StaticMethods.method970(i_15_ - 1, -1369747861);
	...
	float[] method3071(int i) {
		...
		method3063();
		int i_38_ = method3070(StaticMethods.method970(anIntArray7333.length - 1, -1535771411));
		...
		if (bool_51_) {
			...
			int i_71_ = StaticMethods.method970(i_39_ - 1, 1223920235);
