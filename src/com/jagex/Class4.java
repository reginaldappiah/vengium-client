package com.jagex;/* Class4 - Decompiled by JODE
...
public class Class4 {
	int[] anIntArray69;
	static int usableCharactersLength = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\u00a3$%^&*()-_=+[{]};:'@#~,<.>/?\\| \u00c4\u00cb\u00cf\u00d6\u00dc\u00e4\u00eb\u00ef\u00f6\u00fc\u00ff\u00df\u00c1\u00c0\u00c9\u00c8\u00cd\u00cc\u00d3\u00d2\u00da\u00d9\u00e1\u00e0\u00e9\u00e8\u00ed\u00ec\u00f3\u00f2\u00fa\u00f9\u00c2\u00ca\u00ce\u00d4\u00db\u00e2\u00ea\u00ee\u00f4\u00fb\u00c6\u00e6\u00e3\u00c3\u00f5\u00d5\u00e7\u00c7".length();
	static int[] anIntArray71 = new int[256];
	boolean aBoolean72 = false;
	SpriteToolkit[] aClass57Array73;
	int anInt74;
	static String usableCharacters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"\u00a3$%^&*()-_=+[{]};:'@#~,<.>/?\\| \u00c4\u00cb\u00cf\u00d6\u00dc\u00e4\u00eb\u00ef\u00f6\u00fc\u00ff\u00df\u00c1\u00c0\u00c9\u00c8\u00cd\u00cc\u00d3\u00d2\u00da\u00d9\u00e1\u00e0\u00e9\u00e8\u00ed\u00ec\u00f3\u00f2\u00fa\u00f9\u00c2\u00ca\u00ce\u00d4\u00db\u00e2\u00ea\u00ee\u00f4\u00fb\u00c6\u00e6\u00e3\u00c3\u00f5\u00d5\u00e7\u00c7";
	int anInt76;
	...
	void method304(GraphicsToolkit class_ra, String string, int[] is, int i, int i_0_, int i_1_, boolean bool) {
		...
		for (int i_2_ = 0; i_2_ < string.length(); i_2_++) {
			...
			if (bool)
				this.aClass57Array73[i_3_].draw(i + 1, i_0_ + 1, 0, -16777216, 1);
			this.aClass57Array73[i_3_].draw(i, i_0_, 0, i_1_, 1);
	...
	void method305(GraphicsToolkit class_ra, Font font, FontMetrics fontmetrics, char c, int i, boolean bool) {
		...
		Image image = DirectXContext.canvas.createImage(i_4_, i_7_);
		...
		this.aClass57Array73[i] = class_ra.createRenderSprite(is, 0, i_4_, i_4_, i_7_);
	}
	...
	Class4(GraphicsToolkit class_ra, int i, boolean bool, Component component) {
		...
		this.aClass57Array73 = new SpriteToolkit[256];
		this.anIntArray69 = new int[256];
		Font font = new Font("Helvetica", bool ? 1 : 0, i);
		FontMetrics fontmetrics = component.getFontMetrics(font);
		for (int i_16_ = 0; i_16_ < usableCharactersLength; i_16_++)
		...
		if (bool && this.aBoolean72) {
			...
			for (int i_17_ = 0; i_17_ < usableCharactersLength; i_17_++)
			...
			if (!this.aBoolean72) {
				this.aBoolean72 = false;
				for (int i_18_ = 0; i_18_ < usableCharactersLength; i_18_++)
