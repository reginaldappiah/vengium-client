package com.jagex;/* Class298_Sub32_Sub24 - Decompiled by JODE
...
public class Class298_Sub32_Sub24 extends Class298_Sub32 {
	...
	int[] method3131(int i, int i_0_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahm.i(").append(')').toString());
		}
	}
	...
	int[][] method3288(int i) {
		...
		if (aClass239_7380.aBoolean2607) {
			int[] is_6_ = method3129(2, i);
			int[][] is_7_ = method3134(0, i);
			int[][] is_8_ = method3134(1, i);
			int[] is_9_ = is[0];
			int[] is_10_ = is[1];
			int[] is_11_ = is[2];
			int[] is_12_ = is_7_[0];
	...
	void method3137(int i, Buffer buffer) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahm.r(").append(')').toString());
		}
	}
	...
	int[] method3289(int i) {
		int[] is = aClass257_7384.method2448(i);
		if (aClass257_7384.aBoolean2810) {
			int[] is_22_ = method3129(0, i);
			int[] is_23_ = method3129(1, i);
			int[] is_24_ = method3129(2, i);
	...
	int[] method3290(int i) {
		...
		if (aClass257_7384.aBoolean2810) {
			...
			int[] is_28_ = method3129(1, i);
			int[] is_29_ = method3129(2, i);
	...
	int[][] method3132(int i) {
		try {
			int[][] is = aClass239_7380.method2205(i);
			if (aClass239_7380.aBoolean2607) {
				int[] is_33_ = method3129(2, i);
				int[][] is_34_ = method3134(0, i);
				int[][] is_35_ = method3134(1, i);
				int[] is_36_ = is[0];
				int[] is_37_ = is[1];
				int[] is_38_ = is[2];
				int[] is_39_ = is_34_[0];
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("ahm.k(").append(')').toString());
		}
	}

	void method3291(int i, Buffer class298_sub53) {
		if (i == 0)
	...
	int[][] method3292(int i) {
		int[][] is = aClass239_7380.method2205(i);
		if (aClass239_7380.aBoolean2607) {
			int[] is_48_ = method3129(2, i);
			int[][] is_49_ = method3134(0, i);
			int[][] is_50_ = method3134(1, i);
			int[] is_51_ = is[0];
			int[] is_52_ = is[1];
			int[] is_53_ = is[2];
			int[] is_54_ = is_49_[0];
	...
	void method3293(int i, Buffer class298_sub53) {
		if (i == 0)
			aBoolean7382 = class298_sub53.readUByte() == 1;
	}
}
