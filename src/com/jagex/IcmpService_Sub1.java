package com.jagex;/* IcmpService_Sub1 - Decompiled by JODE
...
public class IcmpService_Sub1 extends IcmpService {
    ...
    public static void method4714() {
        if (anIcmpService_Sub1_8551 != null) {
            try {
                anIcmpService_Sub1_8551.quit();
            } catch (Throwable throwable) {
                    /* empty */
            }
            anIcmpService_Sub1_8551 = null;
        }
    }

    public static byte[][][] method6381(int i) {
    ...
    static void method6382(boolean bool, int i) {
        if (bool) {
            ...
            for (Widget class298_sub51 = ((Widget) GameClient.linkedList.method5816()); class298_sub51 != null; class298_sub51 = ((Widget) GameClient.linkedList.method5815())) {
            ...
            GameClient.WINDOW_PANE_ID = -391544995 * Js5List.JS5_DEFAULTS.defaultRootInter;
    ...
    protected void notify(int mousePositionHash, int type, int rotation) {
        Iterator iterator = this.aList8552.iterator();
        while (iterator.hasNext()) {
            Interface22 interface22 = (Interface22) iterator.next();
            interface22.method245(mousePositionHash, type, rotation);
        }
    }

    protected void notify(int mousePositionHash) {
        Iterator iterator = this.aList8552.iterator();
        while (iterator.hasNext()) {
            Interface22 interface22 = (Interface22) iterator.next();
            interface22.method247(0 == mousePositionHash, (byte) 5);
        }
    }

    protected void b(int mousePositionHash, int type, int rotation) {
        Iterator iterator = this.aList8552.iterator();
        while (iterator.hasNext()) {
            Interface22 interface22 = (Interface22) iterator.next();
            interface22.method245(mousePositionHash, type, rotation);
    ...
    protected void p(int mousePositionHash, int type, int rotation) {
        Iterator iterator = this.aList8552.iterator();
        while (iterator.hasNext()) {
            Interface22 interface22 = (Interface22) iterator.next();
            interface22.method245(mousePositionHash, type, rotation);
