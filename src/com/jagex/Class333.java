package com.jagex;/* Class333 - Decompiled by JODE
...
public class Class333 {
	...
	public void method4067(int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_) {
		if (i == 8 || i == 16) {
			if (i == 8) {
				int i_13_ = i_9_ << (this.aClass331_3580.positionHash * -1688804109);
				int i_14_ = i_13_ + (this.aClass331_3580.anInt3536) * 1828905535;
				int i_15_ = i_10_ << (this.aClass331_3580.positionHash * -1688804109);
				int i_16_ = i_15_ + (this.aClass331_3580.anInt3536) * 1828905535;
				int i_17_ = this.aClass331_3580.aClass_xaArray3519[i_8_].method6341(i_9_, i_10_);
				int i_18_ = this.aClass331_3580.aClass_xaArray3519[i_8_].method6341(i_9_ + 1, i_10_ + 1);
				...
				int i_19_ = ((i_9_ << (this.aClass331_3580.positionHash * -1688804109)) + (this.aClass331_3580.anInt3536) * 1828905535);
				int i_20_ = i_19_ - (this.aClass331_3580.anInt3536) * 1828905535;
				int i_21_ = i_10_ << (this.aClass331_3580.positionHash * -1688804109);
				int i_22_ = i_21_ + (this.aClass331_3580.anInt3536) * 1828905535;
				int i_23_ = this.aClass331_3580.aClass_xaArray3519[i_8_].method6341(i_9_ + 1, i_10_);
				int i_24_ = this.aClass331_3580.aClass_xaArray3519[i_8_].method6341(i_9_, i_10_ + 1);
			...
			Class326 class326 = (this.aClass331_3580.gameSceneBase[i_8_][i_9_][i_10_]);
			if (class326 == null)
				this.aClass331_3580.gameSceneBase[i_8_][i_9_][i_10_] = class326 = new Class326(i_8_);
			if (i == 1) {
	...
	public void method4068(int i, int i_25_, int i_26_, int i_27_) {
		if (i == 8 || i == 16) {
			...
			Class326 class326 = (this.aClass331_3580.gameSceneBase[i_25_][i_26_][i_27_]);
			if (class326 != null) {
				if (i == 1)
	...
	void method4069(GraphicsToolkit class_ra, Class328 class328, int i) {
		...
		if (class328.aByte3482 == 1) {
			...
			if (i_30_ >= 0 && i_30_ <= ((this.aClass331_3580.anInt3538) * 583010427 + (this.aClass331_3580.anInt3538) * 583010427)) {
				...
				if (bool) {
					float f = (float) ((this.aClass331_3580.anInt3542 * -343859235) - class328.anIntArray3484[0]);
					if (f < 0.0F)
						f *= -1.0F;
					if (!(f < (float) this.anInt3584) && method4076(class328, 0) && method4076(class328, 1) && method4076(class328, 2) && method4076(class328, 3))
			...
			if (i_33_ >= 0 && i_33_ <= ((this.aClass331_3580.anInt3538) * 583010427 + (this.aClass331_3580.anInt3538) * 583010427)) {
				...
				if (bool) {
					float f = (float) ((this.aClass331_3580.anInt3543 * -1526003751) - class328.anIntArray3486[0]);
					if (f < 0.0F)
						f *= -1.0F;
					if (!(f < (float) this.anInt3584) && method4076(class328, 0) && method4076(class328, 1) && method4076(class328, 2) && method4076(class328, 3))
						this.aClass328Array3593[this.anInt3592++] = class328;
			...
			if (i_36_ >= 0 && i_36_ <= ((this.aClass331_3580.anInt3538) * 583010427 + (this.aClass331_3580.anInt3538) * 583010427)) {
				...
				if (i_37_ >= 0 && (i_37_ <= ((this.aClass331_3580.anInt3538) * 583010427 + (this.aClass331_3580.anInt3538) * 583010427)) && (this.aClass331_3580.aBooleanArrayArray3563[i_36_][i_37_])) {
					...
					if (f < 0.0F)
						f *= -1.0F;
					float f_38_ = (float) ((this.aClass331_3580.anInt3543 * -1526003751) - class328.anIntArray3486[0]);
					if (f_38_ < 0.0F)
						f_38_ *= -1.0F;
					if ((!(f < (float) this.anInt3584) || !(f_38_ < (float) this.anInt3584)) && method4076(class328, 0) && method4076(class328, 1) && method4076(class328, 2) && method4076(class328, 3))
						this.aClass328Array3593[this.anInt3592++] = class328;
				}
			}
		} else if (class328.aByte3482 == 4) {
			float f = (float) (class328.anIntArray3485[0] - (this.aClass331_3580.anInt3544) * 2104557959);
			if (!(f <= (float) this.anInt3600)) {
	...
	Class333(Region class331) {
		...
		this.anInt3592 = 0;
		this.anIntArrayArrayArray3585 = (new int[this.aClass331_3580.anInt3548 * 1678382205][this.aClass331_3580.cameraXLimit * 1988988347 + 1][this.aClass331_3580.cameraYLimit * 1340714547 + 1]);
		this.aBoolean3598 = false;
        aBoolean3583 = !(this.aClass331_3580.aClass_ra3508 instanceof SSEGraphicsToolkit);
		if (aBoolean3583)
	...
	boolean method4071(int i, int i_52_, int i_53_) {
		...
		if (this.aClass331_3580.aClass_xaArray3517 == this.aClass331_3580.aClass_xaArray3521)
			return false;
		int i_55_ = (i_52_ << this.aClass331_3580.positionHash * -1688804109);
		int i_56_ = (i_53_ << this.aClass331_3580.positionHash * -1688804109);
		if (method4066(i_55_ + 1, this.aClass331_3580.aClass_xaArray3517[i].method6341(i_52_, i_53_), i_56_ + 1, i_55_ + (this.aClass331_3580.anInt3536) * 1828905535 - 1, this.aClass331_3580.aClass_xaArray3517[i].method6341(i_52_ + 1, i_53_ + 1), i_56_ + (this.aClass331_3580.anInt3536) * 1828905535 - 1, i_55_ + 1, this.aClass331_3580.aClass_xaArray3517[i].method6341(i_52_, i_53_ + 1), i_56_ + (this.aClass331_3580.anInt3536) * 1828905535 - 1) && method4066(i_55_ + 1, this.aClass331_3580.aClass_xaArray3517[i].method6341(i_52_, i_53_), i_56_ + 1, (i_55_ + (this.aClass331_3580.anInt3536) * 1828905535 - 1), this.aClass331_3580.aClass_xaArray3517[i].method6341(i_52_ + 1, i_53_), i_56_ + 1, (i_55_ + (this.aClass331_3580.anInt3536) * 1828905535 - 1), this.aClass331_3580.aClass_xaArray3517[i].method6341(i_52_ + 1, i_53_ + 1), (i_56_ + (this.aClass331_3580.anInt3536) * 1828905535 - 1))) {
	...
	boolean method4072(Class365_Sub1_Sub5 class365_sub1_sub5, int i, int i_57_, int i_58_) {
		...
		if (!method4071(i, i_57_, i_58_))
			return false;
		int i_59_ = (i_57_ << this.aClass331_3580.positionHash * -1688804109);
		int i_60_ = (i_58_ << this.aClass331_3580.positionHash * -1688804109);
		int i_61_ = (this.aClass331_3580.aClass_xaArray3517[i].method6341(i_57_, i_58_) - 1);
		int i_62_ = i_61_ + class365_sub1_sub5.method4361();
		if (class365_sub1_sub5.aShort9814 == 1) {
			if (!method4066(i_59_, i_61_, i_60_, i_59_, i_62_, i_60_, i_59_, i_62_, (i_60_ + (this.aClass331_3580.anInt3536) * 1828905535)))
				return false;
            return method4066(i_59_, i_61_, i_60_, i_59_, i_62_, (i_60_ + (this.aClass331_3580.anInt3536) * 1828905535), i_59_, i_61_, (i_60_ + (this.aClass331_3580.anInt3536) * 1828905535));
        }
		if (class365_sub1_sub5.aShort9814 == 2) {
			if (!method4066(i_59_, i_61_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535, i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_62_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535, i_59_, i_62_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535))
				return false;
            return method4066(i_59_, i_61_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535, i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_61_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535, i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_62_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535);
        }
		if (class365_sub1_sub5.aShort9814 == 4) {
			if (!method4066(i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_61_, i_60_, i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_62_, i_60_, i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_62_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535))
				return false;
            return method4066(i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_61_, i_60_, i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_62_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535, i_59_ + (this.aClass331_3580.anInt3536) * 1828905535, i_61_, i_60_ + (this.aClass331_3580.anInt3536) * 1828905535);
        }
		if (class365_sub1_sub5.aShort9814 == 8) {
			if (!method4066(i_59_, i_61_, i_60_, (i_59_ + (this.aClass331_3580.anInt3536) * 1828905535), i_62_, i_60_, i_59_, i_62_, i_60_))
				return false;
            return method4066(i_59_, i_61_, i_60_, (i_59_ + (this.aClass331_3580.anInt3536) * 1828905535), i_61_, i_60_, (i_59_ + (this.aClass331_3580.anInt3536) * 1828905535), i_62_, i_60_);
        }
		if (class365_sub1_sub5.aShort9814 == 16) {
            return method4077(i_59_, i_61_, (i_60_ + (this.aClass331_3580.anInt3546) * 394962841), (this.aClass331_3580.anInt3546) * 394962841, i_62_, (this.aClass331_3580.anInt3546) * 394962841);
        }
		if (class365_sub1_sub5.aShort9814 == 32) {
            return method4077((i_59_ + (this.aClass331_3580.anInt3546) * 394962841), i_61_, (i_60_ + (this.aClass331_3580.anInt3546) * 394962841), (this.aClass331_3580.anInt3546) * 394962841, i_62_, (this.aClass331_3580.anInt3546) * 394962841);
        }
		if (class365_sub1_sub5.aShort9814 == 64) {
            return method4077((i_59_ + (this.aClass331_3580.anInt3546) * 394962841), i_61_, i_60_, (this.aClass331_3580.anInt3546) * 394962841, i_62_, (this.aClass331_3580.anInt3546) * 394962841);
        }
		if (class365_sub1_sub5.aShort9814 == 128) {
            return method4077(i_59_, i_61_, i_60_, (this.aClass331_3580.anInt3546) * 394962841, i_62_, (this.aClass331_3580.anInt3546) * 394962841);
        }
		return true;
	}
	...
	boolean method4073(int i, int i_63_, int i_64_, int i_65_) {
		...
		if (!method4071(i, i_63_, i_64_))
			return false;
		int i_66_ = (i_63_ << this.aClass331_3580.positionHash * -1688804109);
		int i_67_ = (i_64_ << this.aClass331_3580.positionHash * -1688804109);
        return method4077(i_66_, this.aClass331_3580.aClass_xaArray3517[i].method6341(i_63_, i_64_), i_67_, (this.aClass331_3580.anInt3536 * 1828905535), i_65_, (this.aClass331_3580.anInt3536 * 1828905535));
    }
	...
	final boolean method4078(int i, int i_82_, int i_83_) {
		aClass_ra3602.method_do((float) i, (float) i_82_, (float) i_83_, this.aFloatArray3601);
	...
	void method4079() {
		...
		for (int i = 0; i < this.aClass331_3580.anInt3548 * 1678382205; i++) {
			for (int i_84_ = 0; (i_84_ < this.aClass331_3580.cameraXLimit * 1988988347); i_84_++) {
				for (int i_85_ = 0; i_85_ < (this.aClass331_3580.cameraYLimit * 1340714547); i_85_++) {
					Class326 class326 = (this.aClass331_3580.gameSceneBase[i][i_85_][i_84_]);
					if (class326 != null) {
		...
		for (int i = 0; i < this.aClass331_3580.anInt3548 * 1678382205; i++) {
			for (int i_86_ = 0; (i_86_ < this.aClass331_3580.cameraXLimit * 1988988347); i_86_++) {
				for (int i_87_ = 0; i_87_ < (this.aClass331_3580.cameraYLimit * 1340714547); i_87_++) {
					Class326 class326 = (this.aClass331_3580.gameSceneBase[i][i_87_][i_86_]);
					if (class326 != null) {
						boolean bool = ((this.aClass331_3580.gameSceneBase[0][i_87_][i_86_]) != null && (this.aClass331_3580.gameSceneBase[0][i_87_][i_86_].aClass326_3455) != null);
						if (class326.aShort3464 < 0) {
							int i_88_ = i_86_;
							int i_89_ = i_86_;
							int i_90_ = i;
							int i_91_ = i;
							Class326 class326_92_ = (this.aClass331_3580.gameSceneBase[i][i_87_][i_88_ - 1]);
							int i_93_;
							for (i_93_ = (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_87_, i_86_)); (i_88_ > 0 && class326_92_ != null && class326_92_.aShort3464 < 0 && (class326_92_.aShort3464 == class326.aShort3464) && (class326_92_.aShort3465 == class326.aShort3465) && i_93_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_87_, i_88_ - 1)) && (i_88_ - 1 <= 0 || i_93_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_87_, i_88_ - 2)))); class326_92_ = (this.aClass331_3580.gameSceneBase[i][i_87_][i_88_ - 1]))
								i_88_--;
							for (class326_92_ = (this.aClass331_3580.gameSceneBase[i][i_87_][i_89_ + 1]); (i_89_ < (this.aClass331_3580.cameraYLimit) * 1340714547 && class326_92_ != null && class326_92_.aShort3464 < 0 && (class326_92_.aShort3464 == class326.aShort3464) && (class326_92_.aShort3465 == class326.aShort3465) && i_93_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_87_, i_89_ + 1)) && (i_89_ + 1 >= ((this.aClass331_3580.cameraYLimit) * 1340714547) || i_93_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_87_, i_89_ + 2)))); class326_92_ = (this.aClass331_3580.gameSceneBase[i][i_87_][i_89_ + 1]))
								i_89_++;
							int i_94_ = i_91_ - i_90_ + 1;
							int i_95_ = this.aClass331_3580.aClass_xaArray3519[bool ? i_90_ + 1 : i_90_].method6341(i_87_, i_88_);
							int i_96_ = (i_95_ + class326.aShort3464 * i_94_);
							int i_97_ = (this.aClass331_3580.aClass_xaArray3519[bool ? i_90_ + 1 : i_90_].method6341(i_87_, i_89_ + 1));
							int i_98_ = (i_97_ + class326.aShort3464 * i_94_);
							int i_99_ = i_87_ << (this.aClass331_3580.positionHash) * -1688804109;
							int i_100_ = i_88_ << (this.aClass331_3580.positionHash) * -1688804109;
							int i_101_ = ((i_89_ << (this.aClass331_3580.positionHash) * -1688804109) + (this.aClass331_3580.anInt3536 * 1828905535));
							...
							for (int i_102_ = i_90_; i_102_ <= i_91_; i_102_++) {
								for (int i_103_ = i_88_; i_103_ <= i_89_; i_103_++)
									this.aClass331_3580.gameSceneBase[i_102_][i_87_][i_103_].aShort3464 *= -1;
							}
						}
						if (class326.aShort3463 < 0) {
							int i_104_ = i_87_;
							...
							int i_106_ = i;
							int i_107_ = i;
							Class326 class326_108_ = (this.aClass331_3580.gameSceneBase[i][i_104_ - 1][i_86_]);
							int i_109_;
							for (i_109_ = (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_87_, i_86_)); (i_104_ > 0 && class326_108_ != null && class326_108_.aShort3463 < 0 && (class326_108_.aShort3463 == class326.aShort3463) && (class326_108_.aShort3467 == class326.aShort3467) && (i_109_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_104_ - 1, i_86_))) && (i_104_ - 1 <= 0 || i_109_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_104_ - 2, i_86_)))); class326_108_ = (this.aClass331_3580.gameSceneBase[i][i_104_ - 1][i_86_]))
								i_104_--;
							for (class326_108_ = (this.aClass331_3580.gameSceneBase[i][i_105_ + 1][i_86_]); (i_105_ < (this.aClass331_3580.cameraXLimit) * 1988988347 && class326_108_ != null && class326_108_.aShort3463 < 0 && (class326_108_.aShort3463 == class326.aShort3463) && (class326_108_.aShort3467 == class326.aShort3467) && (i_109_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_105_ + 1, i_86_))) && (i_105_ + 1 >= (this.aClass331_3580.cameraXLimit) * 1988988347 || i_109_ == (this.aClass331_3580.aClass_xaArray3519[i].method6341(i_105_ + 2, i_86_)))); class326_108_ = (this.aClass331_3580.gameSceneBase[i][i_105_ + 1][i_86_]))
								i_105_++;
							int i_110_ = i_107_ - i_106_ + 1;
							int i_111_ = this.aClass331_3580.aClass_xaArray3519[bool ? i_106_ + 1 : i_106_].method6341(i_104_, i_86_);
							int i_112_ = i_111_ + (class326.aShort3463 * i_110_);
							int i_113_ = (this.aClass331_3580.aClass_xaArray3519[bool ? i_106_ + 1 : i_106_].method6341(i_105_ + 1, i_86_));
							int i_114_ = i_113_ + (class326.aShort3463 * i_110_);
							int i_115_ = i_104_ << (this.aClass331_3580.positionHash) * -1688804109;
							int i_116_ = ((i_105_ << (this.aClass331_3580.positionHash) * -1688804109) + (this.aClass331_3580.anInt3536 * 1828905535));
							int i_117_ = i_86_ << (this.aClass331_3580.positionHash) * -1688804109;
							...
							for (int i_118_ = i_106_; i_118_ <= i_107_; i_118_++) {
								for (int i_119_ = i_104_; i_119_ <= i_105_; i_119_++)
									this.aClass331_3580.gameSceneBase[i_118_][i_119_][i_86_].aShort3463 *= -1;
							}
						}
					}
				}
	...
	void method4081(GraphicsToolkit class_ra, int i) {
		...
		if (!aBoolean3583 || !this.aBoolean3577)
			...
			aClass_ra3602.getDimension(this.anIntArray3589);
			if ((this.anInt3603 != (int) ((float) this.anIntArray3589[0] / 3.0F)) || (this.anInt3604 != (int) ((float) this.anIntArray3589[1] / 3.0F))) {
				this.anInt3603 = (int) ((float) this.anIntArray3589[0] / 3.0F);
				this.anInt3604 = (int) ((float) this.anIntArray3589[1] / 3.0F);
