package com.jagex;/* Class46 - Decompiled by JODE
...
public class Class46 {
	Buffer aBuffer489;
	OpenGLGraphicsToolkit aClass_ra_Sub2_490;
	...
	Class46(OpenGLGraphicsToolkit class_ra_sub2, Buffer buffer) {
		this.aClass_ra_Sub2_490 = class_ra_sub2;
		this.aBuffer489 = buffer;
	}

	Class46(OpenGLGraphicsToolkit class_ra_sub2, byte[] is, int i) {
		this.aClass_ra_Sub2_490 = class_ra_sub2;
		this.aBuffer489 = this.aClass_ra_Sub2_490.aNativeHeap8181.f(i, false);
		if (is != null)
			this.aBuffer489.b(is, 0, 0, i);
