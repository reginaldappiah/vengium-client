package com.jagex;/* Class425 - Decompiled by JODE
...
public class Class425 {
	...
	public static void method5737(Object[] objects, int i, Object[] objects_3_, int i_4_, int length) {
		if (objects == objects_3_) {
			if (i == i_4_)
				return;
			if (i_4_ > i && i_4_ < i + length) {
				length--;
				i += length;
				i_4_ += length;
				length = i - length;
