package com.jagex;/* Class481_Sub1 - Decompiled by JODE
...
public class Class481_Sub1 extends Class481 {
	...
	Socket method6114(String string, int i, String string_0_, int i_1_) throws IOException {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aes.q(").append(')').toString());
		}
	}
		...
		try {
			...
			if (proxy.type() == Proxy.Type.HTTP) {
				...
				try {
					...
					Method method = (var_class.getDeclaredMethod("getProxyAuth", String.class, Integer.TYPE));
					method.setAccessible(true);
					Object object = method.invoke(null, (new Object[] { inetsocketaddress.getHostName(), new Integer(inetsocketaddress.getPort()) }));
					if (object != null) {
						Method method_6_ = (var_class.getDeclaredMethod("supportsPreemptiveAuthorization"));
						method_6_.setAccessible(true);
						if (((Boolean) method_6_.invoke(object)).booleanValue()) {
							Method method_7_ = var_class.getDeclaredMethod("getHeaderName");
							...
							String string_9_ = ((String) method_7_.invoke(object));
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aes.r(").append(')').toString());
		}
	}
	...
	public Socket method6111(int i) throws IOException {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aes.f(").append(')').toString());
		}
	}
}
