package com.jagex;/* Class298_Sub24_Sub1 - Decompiled by JODE
...
public class Class298_Sub24_Sub1 extends Class298_Sub24 {
	...
	TranslatedCanvas aClass298_Sub19_Sub3_9278;
	double aDouble9279;
	int anInt9280;
	public static int anInt9281;
		...
		try {
			if (this.anInt7352 * -1312498565 < 3) {
				...
				if (-1312498565 * this.anInt7352 == 2) {
					...
					this.aClass298_Sub19_Sub3_9278 = new TranslatedCanvas(this.aVorbisInfo9273.channels);
				}
			} else {
				...
				if (-1.0 == this.aDouble9279)
					this.aDouble9279 = (double) ((float) (253299067 * (this.anInt9280)) / (float) (this.aVorbisInfo9273.rate));
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aiy.f(").append(')').toString());
		}
	}
	...
	void method3075(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aiy.b(").append(')').toString());
		}
	}
	...
	double method3081(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aiy.s(").append(')').toString());
		}
	}

	public TranslatedCanvas method3082() {
		try {
			return this.aClass298_Sub19_Sub3_9278;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aiy.n(").append(')').toString());
		}
	}
	...
	int method3083(int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("aiy.z(").append(')').toString());
		}
	}
}
