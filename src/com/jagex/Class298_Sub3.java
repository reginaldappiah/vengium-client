package com.jagex;/* Class298_Sub3 - Decompiled by JODE
 * Visit http://jode.sourceforge.net/
 */

public class Class298_Sub3 extends Node {
	Light aClass298_Sub10_7168;
	Class_xa_Sub3 aClass_xa_Sub3_7169;
	int anInt7170;
	int anInt7171;
	int anInt7172;
	OpenGLGraphicsToolkit aClass_ra_Sub2_7173;
	...
	void method2851(short i) {
		if (this.aClass_ra_Sub2_7173.aBoolean8143)
			this.aClass298_Sub53_7184.writeShort(i);
		else
			this.aClass298_Sub53_7184.method3587(i);
	}
	...
	void method2853(int i, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
		...
		int i_13_ = this.aClass_xa_Sub3_7169.method6340(i_11_, i_12_);
		if ((i_9_ & 0x7f) == 0 || (i_10_ & 0x7f) == 0) {
			l = ((long) i_12_ & 0xffffL) << 16 | (long) i_11_ & 0xffffL;
			Node class298 = this.aClass440_7186.method5852(l);
			if (class298 != null) {
		...
		float f_25_ = (float) (this.aClass298_Sub10_7168.method2895(823958259) - i_11_);
		float f_26_ = (float) (this.aClass298_Sub10_7168.method2894(820885236) - i_13_);
		float f_27_ = (float) (this.aClass298_Sub10_7168.method2897((byte) 86) - i_12_);
		float f_28_ = (float) Math.sqrt((double) (f_25_ * f_25_ + f_26_ * f_26_ + f_27_ * f_27_));
		float f_29_ = 1.0F / f_28_;
		f_25_ *= f_29_;
		f_26_ *= f_29_;
		f_27_ *= f_29_;
		float f_30_ = f_28_ / (float) this.aClass298_Sub10_7168.method2900(-1220224399);
		...
		if (i_37_ > 255)
			i_37_ = 255;
		if (this.aClass_ra_Sub2_7173.aBoolean8143) {
			this.aClass298_Sub53_Sub1_7185.method3658((float) i_11_);
			this.aClass298_Sub53_Sub1_7185.method3658((float) i_13_);
			this.aClass298_Sub53_Sub1_7185.method3658((float) i_12_);
		} else {
			this.aClass298_Sub53_Sub1_7185.method3659((float) i_11_);
			this.aClass298_Sub53_Sub1_7185.method3659((float) i_13_);
			this.aClass298_Sub53_Sub1_7185.method3659((float) i_12_);
		}
	...
	Class298_Sub3(OpenGLGraphicsToolkit class_ra_sub2, Class_xa_Sub3 class_xa_sub3, Light class298_sub10, int[] is) {
			...
			if (i_41_ > 0 && i_41_ < (this.aClass_xa_Sub3_7169.anInt6286) * -1148794921 - 1) {
				for (int i_42_ = 0; i_42_ <= i_38_; i_42_++) {
					...
					if (i_43_ > 0 && i_43_ < (this.aClass_xa_Sub3_7169.anInt6287) * -506105871 - 1) {
						int i_44_ = (class_xa_sub3.method6341(i_43_ + 1, i_41_) - class_xa_sub3.method6341(i_43_ - 1, i_41_));
						int i_45_ = (class_xa_sub3.method6341(i_43_, i_41_ + 1) - class_xa_sub3.method6341(i_43_, i_41_ - 1));
						float f = (float) (1.0 / Math.sqrt((double) (i_44_ * i_44_ + 65536 + (i_45_ * i_45_))));
						this.aFloatArrayArray7181[i_42_][i_40_] = (float) i_44_ * f;
						this.aFloatArrayArray7182[i_42_][i_40_] = -256.0F * f;
						this.aFloatArrayArray7183[i_42_][i_40_] = (float) i_45_ * f;
					}
				}
			}
		}
		...
		if (this.anInt7176 > 0) {
			this.aClass298_Sub53_7184 = new Buffer(this.anInt7176 * 2);
			this.aClass298_Sub53_Sub1_7185 = new RsFloatBuffer(this.anInt7176 * 16);
			this.aClass440_7186 = new Class440(LinkedList.getNextBitValue((this.anInt7176)));
			int i_52_ = 0;
			i_46_ = 0;
			...
			this.anInterface2_7174 = (this.aClass_ra_Sub2_7173.method5284(5123, this.aClass298_Sub53_7184.buffer, (this.aClass298_Sub53_7184.offset * 385051775), false));
			this.anInterface1_7178 = (this.aClass_ra_Sub2_7173.method5244(16, (this.aClass298_Sub53_Sub1_7185.buffer), (this.aClass298_Sub53_Sub1_7185.offset * 385051775), false));
