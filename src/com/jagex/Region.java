package com.jagex;/* Region - Decompiled by JODE
...
public class Region {
	...
	public Class326[][][] gameSceneBase;
	public FloorToolkit[] aClass_xaArray3517;
	public Class326[][][] aClass326ArrayArrayArray3518;
	public FloorToolkit[] aClass_xaArray3519;
	public Class326[][][] aClass326ArrayArrayArray3520;
	public FloorToolkit[] aClass_xaArray3521;
	...
	Light[] aClass298_Sub10Array3529;
	...
	public void method4007(int i, byte i_0_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.a(").append(')').toString());
		}
	}

	public void method4008(FontToolkit class264, int i) {
		try {
			/* empty */
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.f(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub2 method4009(int i, int i_1_, int i_2_, int i_3_) {
		try {
			Class326 class326 = gameSceneBase[i][i_1_][i_2_];
			if (class326 == null)
				return null;
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ax(").append(')').toString());
		}
	}
	...
	public void resetDynamics() {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.m(").append(')').toString());
		}
	}

	public void method4011(int i, int i_5_, int i_6_) {
		try {
			Class326 class326 = gameSceneBase[0][i][i_5_];
			for (int i_7_ = 0; i_7_ < 3; i_7_++) {
				Class326 class326_8_ = (gameSceneBase[i_7_][i][i_5_] = gameSceneBase[i_7_ + 1][i][i_5_]);
				if (null != class326_8_) {
			...
			if (null == gameSceneBase[0][i][i_5_]) {
				gameSceneBase[0][i][i_5_] = new Class326(0);
				gameSceneBase[0][i][i_5_].aByte3466 = (byte) 1;
			}
			gameSceneBase[0][i][i_5_].aClass326_3455 = class326;
			gameSceneBase[3][i][i_5_] = null;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.i(").append(')').toString());
		}
	}

	Class326 method4012(int i, int i_9_, int i_10_, int i_11_) {
		try {
			if (null == gameSceneBase[i][i_9_][i_10_]) {
				boolean bool = (gameSceneBase[0][i_9_][i_10_] != null && null != (gameSceneBase[0][i_9_][i_10_].aClass326_3455));
				if (bool && i >= 1678382205 * anInt3548 - 1)
					return null;
				method4013(i, i_9_, i_10_);
			}
			return gameSceneBase[i][i_9_][i_10_];
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.k(").append(')').toString());
		}
	}

	public void method4013(int i, int i_12_, int i_13_) {
		try {
			boolean bool = (gameSceneBase[0][i_12_][i_13_] != null && (gameSceneBase[0][i_12_][i_13_].aClass326_3455) != null);
			for (int i_15_ = i; i_15_ >= 0; i_15_--) {
				if (gameSceneBase[i_15_][i_12_][i_13_] == null) {
					Class326 class326 = (gameSceneBase[i_15_][i_12_][i_13_] = new Class326(i_15_));
					if (bool)
						class326.aByte3466++;
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.d(").append(')').toString());
		}
	}
	...
	public int method4014(int i, int i_16_, byte i_17_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.posX(").append(')').toString());
		}
	}
	...
	public int method4015(int i, int i_18_, byte i_19_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.r(").append(')').toString());
		}
	}
	...
	public int method4016(int i, int i_20_, byte i_21_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.q(").append(')').toString());
		}
	}
	...
	public int method4017(int i, int i_22_, byte i_23_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.n(").append(')').toString());
		}
	}
	...
	public int method4018(int i, int i_24_, int i_25_) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.z(").append(')').toString());
		}
	}

	public void method4019(int i, int i_26_, int waterColor, int waterScale, int waterIntensity, int i_30_, int i_31_, int i_32_) {
		try {
			if (null != this.anIntArrayArray3522)
				this.anIntArrayArray3522[i][i_26_] = ~0xffffff | waterColor;
			if (this.aShortArrayArray3523 != null)
				this.aShortArrayArray3523[i][i_26_] = (short) waterScale;
			if (null != this.aByteArrayArray3524)
				this.aByteArrayArray3524[i][i_26_] = (byte) waterIntensity;
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.posY(").append(')').toString());
		}
	}
	...
	public void method4020(int i, int i_34_, int i_35_, Class365_Sub1_Sub5 class365_sub1_sub5, Class365_Sub1_Sub5 class365_sub1_sub5_36_, byte i_37_) {
		try {
			...
			if (null != class326) {
				...
				if (class365_sub1_sub5.method4399()) {
					if (class365_sub1_sub5.method4376()) {
				...
				if (class365_sub1_sub5_36_ != null) {
					if (class365_sub1_sub5_36_.method4399()) {
						if (class365_sub1_sub5_36_.method4376()) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.v(").append(')').toString());
		}
	}
	...
	public void method4021(int i, int i_39_, int i_40_, Class365_Sub1_Sub3 class365_sub1_sub3, Class365_Sub1_Sub3 class365_sub1_sub3_41_, int i_42_) {
		try {
			...
			if (class326 != null) {
				...
				if (class365_sub1_sub3.method4399()) {
					if (class365_sub1_sub3.method4376()) {
				...
				if (null != class365_sub1_sub3_41_) {
					if (class365_sub1_sub3_41_.method4399()) {
						if (class365_sub1_sub3_41_.method4376()) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.g(").append(')').toString());
		}
	}
	...
	public boolean method4022(Class365_Sub1_Sub1 class365_sub1_sub1, boolean bool, byte i) {
		try {
			...
			short i_46_ = 0;
			byte i_47_ = 0;
			class365_sub1_sub1.method4404();
			if (class365_sub1_sub1.aShort9798 < 0 || class365_sub1_sub1.aShort9795 < 0 || class365_sub1_sub1.aShort9796 >= 1988988347 * cameraXLimit || class365_sub1_sub1.aShort9797 >= cameraYLimit * 1340714547)
				return false;
			short i_48_ = 0;
			for (int i_49_ = class365_sub1_sub1.aShort9798; i_49_ <= class365_sub1_sub1.aShort9796; i_49_++) {
				for (int i_50_ = class365_sub1_sub1.aShort9795; i_50_ <= class365_sub1_sub1.aShort9797; i_50_++) {
					...
					if (class326 != null) {
						Class322 class322 = Class322.method2199(class365_sub1_sub1);
			...
			if (bool) {
				...
				if (class365_sub1_sub1.method4399()) {
					if (class365_sub1_sub1.method4376()) {
			...
			if (bool) {
				Vector3f class217 = Vector3f.method2005(class365_sub1_sub1.getWorldTransform().trans);
				class217.y -= (float) i_48_;
				class365_sub1_sub1.method4340(class217);
				class217.cache();
			}
			return true;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.e(").append(')').toString());
		}
	}

	public void method4023(int i, int i_55_, int i_56_, int i_57_, byte i_58_) {
		try {
			Class326 class326 = gameSceneBase[i][i_55_][i_56_];
			if (null != class326) {
				...
				if (null != class365_sub1_sub3) {
					class365_sub1_sub3.aShort9802 = (short) (i_57_ * class365_sub1_sub3.aShort9802 / (16 << positionHash * -1688804109 - 7));
					class365_sub1_sub3.aShort9803 = (short) (class365_sub1_sub3.aShort9803 * i_57_ / (16 << -1688804109 * positionHash - 7));
				}
				if (class365_sub1_sub3_59_ != null) {
					class365_sub1_sub3_59_.aShort9802 = (short) (i_57_ * class365_sub1_sub3_59_.aShort9802 / (16 << positionHash * -1688804109 - 7));
					class365_sub1_sub3_59_.aShort9803 = (short) (class365_sub1_sub3_59_.aShort9803 * i_57_ / (16 << positionHash * -1688804109 - 7));
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.c(").append(')').toString());
		}
	}
	...
	public void method4024(byte i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.am(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub5 method4025(int i, int i_60_, int i_61_) {
		try {
			Class326 class326 = gameSceneBase[i][i_60_][i_61_];
			if (class326 != null) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.w(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub5 method4026(int i, int i_63_, int i_64_) {
		try {
			Class326 class326 = gameSceneBase[i][i_63_][i_64_];
			if (null != class326) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.j(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub3 method4027(int i, int i_66_, int i_67_) {
		try {
			Class326 class326 = gameSceneBase[i][i_66_][i_67_];
			if (class326 != null) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.l(").append(')').toString());
		}
	}

	public Region(GraphicsToolkit toolkit, int i, int i_69_, int x, int y, int i_72_, boolean bool, boolean bool_73_) {
		this.aFloatArray3505 = new float[3];
		this.aClass298_Sub10Array3529 = new Light[8];
		this.aClass_ra3508 = toolkit;
		this.aBoolean3510 = this.aClass_ra3508.method5048() > 0;
		positionHash = i * -1524575173;
		this.anInt3536 = (1 << positionHash * -1688804109) * 732171711;
		this.anInt3546 = -413418327 * (this.anInt3536 * 1828905535 >> 1);
		anInt3548 = i_69_ * 1634141397;
		cameraXLimit = 1005334387 * x;
		cameraYLimit = -1342636805 * y;
		this.anInt3538 = i_72_ * 1571198643;
		this.aClass480_3509 = new Class480();
		aClass333_3512 = new Class333(this);
		aClass326ArrayArrayArray3518 = (new Class326[i_69_][1988988347 * cameraXLimit][1340714547 * cameraYLimit]);
		aClass_xaArray3519 = new FloorToolkit[i_69_];
		if (bool) {
			this.anIntArrayArray3522 = new int[1988988347 * cameraXLimit][1340714547 * cameraYLimit];
			this.aByteArrayArray3524 = new byte[1988988347 * cameraXLimit][1340714547 * cameraYLimit];
			this.aShortArrayArray3523 = new short[cameraXLimit * 1988988347][1340714547 * cameraYLimit];
			this.aByteArrayArray3525 = new byte[1988988347 * cameraXLimit][1340714547 * cameraYLimit];
			this.aByteArrayArray3526 = new byte[cameraXLimit * 1988988347][cameraYLimit * 1340714547];
			this.aByteArrayArray3527 = new byte[cameraXLimit * 1988988347][1340714547 * cameraYLimit];
			aClass326ArrayArrayArray3520 = (new Class326[1][cameraXLimit * 1988988347][cameraYLimit * 1340714547]);
			aClass_xaArray3521 = new FloorToolkit[1];
		}
		if (bool_73_) {
			this.aLongArrayArrayArray3554 = new long[i_69_][x][y];
	...
	public Class365_Sub1_Sub1 method4028(int i, int i_74_, int i_75_, Interface17 interface17) {
		try {
			Class326 class326 = gameSceneBase[i][i_74_][i_75_];
			if (null == class326)
				return null;
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ak(").append(')').toString());
		}
	}
		...
		try {
			for (int i_77_ = class365_sub1_sub1.aShort9798; i_77_ <= class365_sub1_sub1.aShort9796; i_77_++) {
				for (int i_78_ = class365_sub1_sub1.aShort9795; i_78_ <= class365_sub1_sub1.aShort9797; i_78_++) {
					Class326 class326 = (gameSceneBase[class365_sub1_sub1.plane][i_77_][i_78_]);
					if (class326 != null) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ae(").append(')').toString());
		}
	}
	...
	void method4030(Class365_Sub1 class365_sub1, int i) {
		try {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ao(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub5 method4031(int i, int i_85_, int i_86_) {
		try {
			Class326 class326 = gameSceneBase[i][i_85_][i_86_];
			if (class326 == null)
				return null;
			return class326.aClass365_Sub1_Sub5_3457;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ad(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub5 method4032(int i, int i_88_, int i_89_) {
		try {
			Class326 class326 = gameSceneBase[i][i_88_][i_89_];
			if (null == class326)
				return null;
			return class326.aClass365_Sub1_Sub5_3458;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.av(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub3 method4033(int i, int i_91_, int i_92_) {
		try {
			Class326 class326 = gameSceneBase[i][i_91_][i_92_];
			if (null == class326)
				return null;
			return class326.aClass365_Sub1_Sub3_3459;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.at(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub4 method4034(int plane, int x, int y) {
		try {
			Class326 class326 = gameSceneBase[plane][x][y];
			if (class326 == null)
				return null;
			return class326.aClass365_Sub1_Sub4_3462;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ah(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub1 method4035(int i, int i_97_, int i_98_, Interface17 interface17) {
		try {
			Class326 class326 = gameSceneBase[i][i_97_][i_98_];
			if (class326 == null)
				return null;
			for (Class322 class322 = class326.aClass322_3456; class322 != null; class322 = class322.aClass322_3360) {
				Class365_Sub1_Sub1 class365_sub1_sub1 = class322.aClass365_Sub1_Sub1_3359;
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ai(").append(')').toString());
		}
	}

	public Class322 method4036(int i, int i_100_, int i_101_, int i_102_) {
		try {
			Class326 class326 = gameSceneBase[i][i_100_][i_101_];
			if (class326 == null)
				return null;
			return class326.aClass322_3456;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.al(").append(')').toString());
		}
	}

	public void method4037() {
		for (int i = 0; i < 1678382205 * anInt3548; i++) {
			for (int i_103_ = 0; i_103_ < cameraXLimit * 1988988347; i_103_++) {
				for (int i_104_ = 0; i_104_ < 1340714547 * cameraYLimit; i_104_++) {
					Class326 class326 = gameSceneBase[i][i_103_][i_104_];
					if (null != class326) {
						Class365_Sub1_Sub5 class365_sub1_sub5 = class326.aClass365_Sub1_Sub5_3457;
						Class365_Sub1_Sub5 class365_sub1_sub5_105_ = class326.aClass365_Sub1_Sub5_3458;
						if (null != class365_sub1_sub5 && class365_sub1_sub5.method4366()) {
							method4039(class365_sub1_sub5, i, i_103_, i_104_, 1, 1);
							if (class365_sub1_sub5_105_ != null && class365_sub1_sub5_105_.method4366()) {
								method4039(class365_sub1_sub5_105_, i, i_103_, i_104_, 1, 1);
								class365_sub1_sub5_105_.method4355(this.aClass_ra3508, class365_sub1_sub5, 0, 0, 0, false);
								class365_sub1_sub5_105_.method4398();
							}
							class365_sub1_sub5.method4398();
						}
						for (Class322 class322 = class326.aClass322_3456; class322 != null; class322 = class322.aClass322_3360) {
							Class365_Sub1_Sub1 class365_sub1_sub1 = class322.aClass365_Sub1_Sub1_3359;
							if (class365_sub1_sub1 != null && class365_sub1_sub1.method4366()) {
								...
								class365_sub1_sub1.method4398();
							}
						}
						Class365_Sub1_Sub2 class365_sub1_sub2 = class326.aClass365_Sub1_Sub2_3461;
						if (null != class365_sub1_sub2 && class365_sub1_sub2.method4366()) {
							method4038(class365_sub1_sub2, i, i_103_, i_104_, 795291520);
							class365_sub1_sub2.method4398();
						}
					}
				}
			}
	...
	void method4038(Class365_Sub1 class365_sub1, int i, int i_106_, int i_107_, int i_108_) {
		try {
			if (i_106_ < cameraXLimit * 1988988347) {
				Class326 class326 = gameSceneBase[i][i_106_ + 1][i_107_];
				if (class326 != null && class326.aClass365_Sub1_Sub2_3461 != null && class326.aClass365_Sub1_Sub2_3461.method4366())
					class365_sub1.method4355(this.aClass_ra3508, class326.aClass365_Sub1_Sub2_3461, (1828905535 * this.anInt3536), 0, 0, true);
			}
			if (i_107_ < 1988988347 * cameraXLimit) {
				Class326 class326 = gameSceneBase[i][i_106_][i_107_ + 1];
				if (class326 != null && null != class326.aClass365_Sub1_Sub2_3461 && class326.aClass365_Sub1_Sub2_3461.method4366())
					class365_sub1.method4355(this.aClass_ra3508, class326.aClass365_Sub1_Sub2_3461, 0, 0, (1828905535 * this.anInt3536), true);
			}
			if (i_106_ < 1988988347 * cameraXLimit && i_107_ < cameraYLimit * 1340714547) {
				Class326 class326 = gameSceneBase[i][1 + i_106_][i_107_ + 1];
				if (null != class326 && null != class326.aClass365_Sub1_Sub2_3461 && class326.aClass365_Sub1_Sub2_3461.method4366())
					class365_sub1.method4355(this.aClass_ra3508, class326.aClass365_Sub1_Sub2_3461, (this.anInt3536 * 1828905535), 0, (this.anInt3536 * 1828905535), true);
			}
			if (i_106_ < 1988988347 * cameraXLimit && i_107_ > 0) {
				Class326 class326 = gameSceneBase[i][i_106_ + 1][i_107_ - 1];
				if (null != class326 && class326.aClass365_Sub1_Sub2_3461 != null && class326.aClass365_Sub1_Sub2_3461.method4366())
					class365_sub1.method4355(this.aClass_ra3508, class326.aClass365_Sub1_Sub2_3461, (this.anInt3536 * 1828905535), 0, -(1828905535 * this.anInt3536), true);
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ap(").append(')').toString());
		}
	}
		...
		for (int i_117_ = i; i_117_ <= i + 1; i_117_++) {
			if (anInt3548 * 1678382205 != i_117_) {
				for (int i_118_ = i_113_; i_118_ <= i_114_; i_118_++) {
					if (i_118_ >= 0 && i_118_ < cameraXLimit * 1988988347) {
						for (int i_119_ = i_115_; i_119_ <= i_116_; i_119_++) {
							if (i_119_ >= 0 && i_119_ < 1340714547 * cameraYLimit && (!bool || i_118_ >= i_114_ || i_119_ >= i_116_ || i_119_ < i_110_ && i_118_ != i_109_)) {
								Class326 class326 = (gameSceneBase[i_117_][i_118_][i_119_]);
								if (null != class326) {
									int i_120_ = (((aClass_xaArray3517[i_117_].method6341(i_118_, i_119_)) + (aClass_xaArray3517[i_117_].method6341(1 + i_118_, i_119_)) + (aClass_xaArray3517[i_117_].method6341(i_118_, 1 + i_119_)) + (aClass_xaArray3517[i_117_].method6341(i_118_ + 1, i_119_ + 1))) / 4 - ((aClass_xaArray3517[i].method6341(i_109_, i_110_)) + (aClass_xaArray3517[i].method6341(i_109_ + 1, i_110_)) + (aClass_xaArray3517[i].method6341(i_109_, 1 + i_110_)) + (aClass_xaArray3517[i].method6341(1 + i_109_, 1 + i_110_))) / 4);
									Class365_Sub1_Sub5 class365_sub1_sub5 = class326.aClass365_Sub1_Sub5_3457;
									Class365_Sub1_Sub5 class365_sub1_sub5_121_ = class326.aClass365_Sub1_Sub5_3458;
									if (class365_sub1_sub5 != null && class365_sub1_sub5.method4366())
										class365_sub1.method4355(this.aClass_ra3508, class365_sub1_sub5, ((this.anInt3546 * 394962841 * (1 - i_111_)) + (1828905535 * this.anInt3536 * (i_118_ - i_109_))), i_120_, (((i_119_ - i_110_) * (1828905535 * (this.anInt3536))) + (this.anInt3546 * 394962841 * (1 - i_112_))), bool);
									if (class365_sub1_sub5_121_ != null && class365_sub1_sub5_121_.method4366())
										class365_sub1.method4355(this.aClass_ra3508, class365_sub1_sub5_121_, ((this.anInt3536 * 1828905535 * (i_118_ - i_109_)) + (this.anInt3546 * 394962841 * (1 - i_111_))), i_120_, ((1828905535 * this.anInt3536 * (i_119_ - i_110_)) + ((1 - i_112_) * (394962841 * (this.anInt3546)))), bool);
									for (Class322 class322 = class326.aClass322_3456; null != class322; class322 = class322.aClass322_3360) {
										Class365_Sub1_Sub1 class365_sub1_sub1 = (class322.aClass365_Sub1_Sub1_3359);
										if (class365_sub1_sub1 != null && class365_sub1_sub1.method4366() && ((class365_sub1_sub1.aShort9798 == i_118_) || i_113_ == i_118_) && ((class365_sub1_sub1.aShort9795 == i_119_) || i_115_ == i_119_)) {
											...
											class365_sub1.method4355((this.aClass_ra3508), class365_sub1_sub1, ((1828905535 * (this.anInt3536) * ((class365_sub1_sub1.aShort9798) - i_109_)) + ((i_122_ - i_111_) * (394962841 * (this.anInt3546)))), i_120_, ((((class365_sub1_sub1.aShort9795) - i_110_) * ((this.anInt3536) * 1828905535)) + (394962841 * (this.anInt3546) * (i_123_ - i_112_))), bool);
										}
									}
								}
							}
	...
	public void method4040(int clientTick, int cameraPosX, int cameraPosY, int cameraPosZ, byte[][][] roofFlags, int[] is_127_, int[] is_128_, int[] is_129_, int[] is_130_, int[] is_131_, int abovePlane, byte removeRoof, int vertexX, int vertexZ, boolean flickeringEffects, boolean bool_136_, int i_137_, boolean bool_138_) {
		aClass333_3512.aBoolean3577 = true;
		this.aBoolean3511 = bool_136_;
		this.anInt3553 = (cameraPosX >> positionHash * -1688804109) * -14089225;
		this.anInt3513 = (cameraPosZ >> -1688804109 * positionHash) * 1732036403;
		this.anInt3542 = cameraPosX * -648073099;
		this.anInt3543 = cameraPosZ * -701298583;
		this.anInt3544 = cameraPosY * -1885539273;
		...
		if (this.anInt3550 * 945006459 > cameraXLimit * 1988988347)
			this.anInt3550 = cameraXLimit * -1126318399;
		this.anInt3552 = (this.anInt3538 * -1363529219 + this.anInt3513 * -690201987);
		if (this.anInt3552 * 779833815 > cameraYLimit * 1340714547)
			this.anInt3552 = 1467937541 * cameraYLimit;
		...
		if (this.aBoolean3511) {
			for (int i_140_ = 0; i_140_ < (583010427 * this.anInt3538 + this.anInt3538 * 583010427 + 2); i_140_++) {
				...
				for (int i_143_ = 0; i_143_ < (583010427 * this.anInt3538 + this.anInt3538 * 583010427 + 2); i_143_++) {
					...
					if (i_144_ >= 0 && i_145_ >= 0 && i_144_ < 1988988347 * cameraXLimit && i_145_ < 1340714547 * cameraYLimit) {
						int i_146_ = i_144_ << positionHash * -1688804109;
						int i_147_ = i_145_ << -1688804109 * positionHash;
						int i_148_ = (aClass_xaArray3519[aClass_xaArray3519.length - 1].method6341(i_144_, i_145_) - (1000 << -1688804109 * positionHash - 7));
						int i_149_ = ((null != aClass_xaArray3521 ? (aClass_xaArray3521[0].method6341(i_144_, i_145_) + 1828905535 * this.anInt3536) : (aClass_xaArray3519[0].method6341(i_144_, i_145_) + 1828905535 * this.anInt3536)) + (1000 << positionHash * -1688804109 - 7));
			...
			if (!bool_138_)
				...
				aClass333_3512.method4081(this.aClass_ra3508, abovePlane);
			}
		} else {
			...
			this.anInt3533 = 0;
			this.anInt3551 = 0;
			this.anInt3550 = -1126318399 * cameraXLimit;
			this.anInt3552 = cameraYLimit * 1467937541;
			aClass333_3512.aBoolean3577 = false;
		}
		ConfigDefinitions.method3977(this, this.aClass_ra3508);
		...
		if (this.aBoolean3510) {
			for (int i_153_ = 0; i_153_ < this.anInt3556 * -2060364501; i_153_++)
				this.aClass321Array3558[i_153_].method3918(clientTick, flickeringEffects);
		}
		if (aClass326ArrayArrayArray3520 != null) {
			...
			method4041(true, roofFlags, abovePlane, removeRoof, i_137_);
			this.aClass_ra3508.O();
			method4052(false, -740850409);
		}
		method4041(false, roofFlags, abovePlane, removeRoof, i_137_);
		if (!this.aBoolean3511) {
	...
	void method4041(boolean bool, byte[][][] is, int i, byte i_154_, int i_155_) {
			...
			if (!bool) {
				for (int i_157_ = 0; i_157_ < 1204219039 * this.anInt3541; i_157_++) {
					...
					if (-1 != this.aClass365_Sub1_Sub1Array3539[i_157_].anInt7725 * -1235150701 && !method4045((this.aClass365_Sub1_Sub1Array3539[i_157_]), bool, is, i, i_154_)) {
						if (this.aClass365_Sub1_Sub1Array3539[i_157_].method4376())
		...
		if (this.aBoolean3510)
			this.aClass_ra3508.setLights(0, null);
		if (0 == (i_155_ & 0x2)) {
			for (int i_159_ = 0; i_159_ < anInt3548 * 1678382205; i_159_++) {
				if (i_159_ >= i && null != is) {
					int i_160_ = this.aBooleanArrayArray3563.length;
					if ((this.aBooleanArrayArray3563.length + 1387802915 * this.anInt3533) > 1988988347 * cameraXLimit)
						i_160_ -= (this.anInt3533 * 1387802915 + (this.aBooleanArrayArray3563).length - 1988988347 * cameraXLimit);
					int i_161_ = this.aBooleanArrayArray3563[0].length;
					if ((1655515601 * this.anInt3551 + this.aBooleanArrayArray3563[0].length) > cameraYLimit * 1340714547)
						i_161_ -= (1655515601 * this.anInt3551 + (this.aBooleanArrayArray3563[0]).length - 1340714547 * cameraYLimit);
							...
							for (int i_164_ = (this.anInt3507 * -301075153); i_164_ < i_161_; i_164_++) {
								...
								if (this.aBooleanArrayArray3563[i_162_][i_164_]) {
									...
									for (int i_166_ = i_159_; i_166_ >= 0; i_166_--) {
										if ((gameSceneBase[i_166_][i_163_][i_165_]) != null && (gameSceneBase[i_166_][i_163_][i_165_].aByte3466) == i_159_) {
                                            bools[i_162_][i_164_] = !((i_166_ >= i && (is[i_166_][i_163_][i_165_] == i_154_)) || (aClass333_3512.method4071(i_159_, i_163_, i_165_)));
											break;
										}
									}
								}
					...
					if ((1387802915 * this.anInt3533 + this.aBooleanArrayArray3563.length) > cameraXLimit * 1988988347)
						i_167_ -= (1387802915 * this.anInt3533 + (this.aBooleanArrayArray3563).length - 1988988347 * cameraXLimit);
					int i_168_ = this.aBooleanArrayArray3563[0].length;
					if ((1655515601 * this.anInt3551 + this.aBooleanArrayArray3563[0].length) > cameraYLimit * 1340714547)
						i_168_ -= ((this.aBooleanArrayArray3563[0]).length + this.anInt3551 * 1655515601 - cameraYLimit * 1340714547);
					boolean[][] bools = this.aBooleanArrayArray3561;
					if (this.aBoolean3511) {
						for (int i_169_ = this.anInt3547 * -1810993483; i_169_ < i_167_; i_169_++) {
							...
							for (int i_171_ = (this.anInt3507 * -301075153); i_171_ < i_168_; i_171_++) {
                                bools[i_169_][i_171_] = (this.aBooleanArrayArray3563[i_169_][i_171_]) && !(aClass333_3512.method4071(i_159_, i_170_, (i_171_ + (this.anInt3551 * 1655515601) - (this.anInt3507 * -301075153))));
							}
						}
					}
	...
	void method4042(Class365_Sub1 class365_sub1, int i) {
		try {
			...
			this.aClass_ra3508.method_do((float) (int) class217.x, (float) ((int) class217.y + (class365_sub1.method4361() >> 1)), (float) (int) class217.z, this.aFloatArray3505);
			class365_sub1.anInt7725 = 144688539 * (int) this.aFloatArray3505[2];
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.aj(").append(')').toString());
		}
	}
	...
	boolean method4045(Class365_Sub1 class365_sub1, boolean bool, byte[][][] is, int i, byte i_185_) {
			...
			for (int i_190_ = i_188_; i_190_ <= i_186_; i_190_++) {
				for (int i_191_ = i_189_; i_191_ <= i_187_; i_191_++) {
					if (class365_sub1.aByte7724 < 1678382205 * anInt3548 && i_190_ >= this.anInt3533 * 1387802915 && i_190_ < this.anInt3550 * 945006459 && i_191_ >= 1655515601 * this.anInt3551 && i_191_ < this.anInt3552 * 779833815) {
						if ((is != null && class365_sub1.plane >= i && (is[class365_sub1.plane][i_190_][i_191_] == i_185_)) || !class365_sub1.method4360(1467136065) || class365_sub1.method4364((this.aClass_ra3508))) {
		...
		Vector3f class217 = class365_sub1.getWorldTransform().trans;
		int i_192_ = (int) class217.x >> positionHash * -1688804109;
		int i_193_ = (int) class217.z >> -1688804109 * positionHash;
		if (class365_sub1.aByte7724 < anInt3548 * 1678382205 && i_192_ >= 1387802915 * this.anInt3533 && i_192_ < 945006459 * this.anInt3550 && i_193_ >= 1655515601 * this.anInt3551 && i_193_ < 779833815 * this.anInt3552) {
			if ((is != null && class365_sub1.plane >= i && is[class365_sub1.plane][i_192_][i_193_] == i_185_) || !class365_sub1.method4360(1252283375) || class365_sub1.method4364(this.aClass_ra3508)) {
	...
	void method4046(Class365_Sub1 class365_sub1, Light[] class298_sub10s) {
		if (this.aBoolean3510) {
			int i = class365_sub1.method4354(class298_sub10s, -331363526);
			this.aClass_ra3508.setLights(i, class298_sub10s);
		}
		if (aClass_xaArray3517 == aClass_xaArray3521) {
			...
			if (class365_sub1 instanceof Class365_Sub1_Sub1) {
				...
				i = (int) class217.x >> positionHash * -1688804109;
				i_195_ = (int) class217.z >> positionHash * -1688804109;
			}
			...
			class78.anInt730 = method4060(i, i_195_) * -1927451111;
			class78.anInt732 = method4018(i, i_195_, -1965414520) * -875460563;
			this.aClass_ra3508.method5058(aClass_xaArray3519[0].method6340((int) class217.x, (int) class217.z), class78);
		}
		Class335 class335 = class365_sub1.method4394(this.aClass_ra3508);
		if (null != class335) {
	...
	public void method4047(Class_na class_na, int i, int i_196_, int i_197_, boolean[] bools, int i_198_) {
		try {
			if (aClass_xaArray3521 != aClass_xaArray3517) {
				int i_199_ = aClass_xaArray3519[i].method6340(i_196_, i_197_);
				for (int i_200_ = 0; i_200_ <= i; i_200_++) {
					if (bools == null || bools[i_200_]) {
						FloorToolkit class_xa = aClass_xaArray3519[i_200_];
						if (null == class_xa) {
							if (i_198_ <= 16711935)
								break;
						} else
							class_xa.NA(class_na, i_196_, (i_199_ - class_xa.method6340(i_196_, i_197_)), i_197_, 0, false);
					}
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ar(").append(')').toString());
		}
	}
	...
	void method4048(int i, int i_201_, int i_202_) {
		try {
			...
			for (int i_203_ = i; i_203_ < i_201_; i_203_++) {
				FloorToolkit class_xa = aClass_xaArray3519[i_203_];
				if (null != class_xa) {
					for (int i_204_ = 0; i_204_ < 1340714547 * cameraYLimit; i_204_++) {
						for (int i_205_ = 0; i_205_ < cameraXLimit * 1988988347; i_205_++) {
							class_na = class_xa.w(i_205_, i_204_, class_na);
							if (null != class_na) {
								int i_206_ = i_205_ << -1688804109 * positionHash;
								int i_207_ = i_204_ << -1688804109 * positionHash;
								for (int i_208_ = i_203_ - 1; i_208_ >= 0; i_208_--) {
									FloorToolkit class_xa_209_ = aClass_xaArray3519[i_208_];
									if (class_xa_209_ == null) {
										if (i_202_ == -787522086)
											return;
									} else {
										int i_210_ = (class_xa.method6341(i_205_, i_204_) - (class_xa_209_.method6341(i_205_, i_204_)));
										int i_211_ = (class_xa.method6341(1 + i_205_, i_204_) - (class_xa_209_.method6341(1 + i_205_, i_204_)));
										int i_212_ = (class_xa.method6341(1 + i_205_, i_204_ + 1) - (class_xa_209_.method6341(1 + i_205_, i_204_ + 1)));
										int i_213_ = (class_xa.method6341(i_205_, 1 + i_204_) - (class_xa_209_.method6341(i_205_, 1 + i_204_)));
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.ac(").append(')').toString());
		}
	}
		...
		try {
			for (int i_214_ = 0; i_214_ < -2060364501 * this.anInt3556; i_214_++) {
				if (!this.aBooleanArray3559[i_214_]) {
					...
					int i_217_ = 1 + (2 * i_216_ >> -1688804109 * positionHash);
					int i_218_ = 0;
					int[] is = new int[i_217_ * i_217_];
					int i_219_ = (class298_sub10.method2895(823958259) - i_216_ >> positionHash * -1688804109);
					int i_220_ = (class298_sub10.method2897((byte) 84) - i_216_ >> -1688804109 * positionHash);
					int i_221_ = (class298_sub10.method2897((byte) 73) + i_216_ >> positionHash * -1688804109);
					if (i_220_ < 0) {
						i_218_ -= i_220_;
						i_220_ = 0;
					}
					if (i_221_ >= cameraYLimit * 1340714547)
						i_221_ = 1340714547 * cameraYLimit - 1;
					for (int i_222_ = i_220_; i_222_ <= i_221_; i_222_++) {
						...
						if (i_227_ >= cameraXLimit * 1988988347)
							i_227_ = 1988988347 * cameraXLimit - 1;
						for (int i_228_ = i_226_; i_228_ <= i_227_; i_228_++) {
							int i_229_ = 1;
							Class365_Sub1_Sub1 class365_sub1_sub1 = method4035(i_215_, i_228_, i_222_, null);
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.bf(").append(')').toString());
		}
	}

	public void method4050(int i) {
		try {
			for (int i_244_ = 0; i_244_ < cameraXLimit * 1988988347; i_244_++) {
				for (int i_245_ = 0; i_245_ < cameraYLimit * 1340714547; i_245_++) {
					if (null == gameSceneBase[0][i_244_][i_245_])
						gameSceneBase[0][i_244_][i_245_] = new Class326(0);
				}
			}
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.p(").append(')').toString());
		}
	}
		...
		try {
			if (this.anInt3556 * -2060364501 < 65391) {
				...
				for (int i_248_ = i_246_; i_248_ <= i_247_; i_248_++) {
					int i_249_ = 0;
					int i_250_ = ((class298_sub10.method2897((byte) 46) - class298_sub10.method2900(1506691) + 394962841 * this.anInt3546) >> positionHash * -1688804109);
					if (i_250_ < 0) {
						i_249_ -= i_250_;
						i_250_ = 0;
					}
					int i_251_ = ((class298_sub10.method2897((byte) 8) + class298_sub10.method2900(-884319007) - this.anInt3546 * 394962841) >> -1688804109 * positionHash);
					if (i_251_ >= 1340714547 * cameraYLimit)
						i_251_ = cameraYLimit * 1340714547 - 1;
					for (int i_252_ = i_250_; i_252_ <= i_251_; i_252_++) {
						int i_253_ = class321.aShortArray3350[i_249_++];
						int i_254_ = (((class298_sub10.method2895(823958259) - class298_sub10.method2900(-701525248) + this.anInt3546 * 394962841) >> positionHash * -1688804109) + (i_253_ >>> 8));
						int i_255_ = i_254_ + (i_253_ & 0xff) - 1;
						if (i_254_ < 0)
							i_254_ = 0;
						if (i_255_ >= 1988988347 * cameraXLimit)
							i_255_ = 1988988347 * cameraXLimit - 1;
						for (int i_256_ = i_254_; i_256_ <= i_255_; i_256_++) {
							long l = (this.aLongArrayArrayArray3554[i_248_][i_256_][i_252_]);
							if ((l & 0xffffL) == 0L)
								this.aLongArrayArrayArray3554[i_248_][i_256_][i_252_] = l | (long) (this.anInt3556 * -2060364501);
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.bd(").append(')').toString());
		}
	}
	...
	public void method4052(boolean bool, int i) {
		try {
			if (bool) {
				gameSceneBase = aClass326ArrayArrayArray3520;
				aClass_xaArray3517 = aClass_xaArray3521;
			} else {
				gameSceneBase = aClass326ArrayArrayArray3518;
				aClass_xaArray3517 = aClass_xaArray3519;
			}
			anInt3548 = gameSceneBase.length * 1634141397;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.b(").append(')').toString());
		}
	}
	...
	public void method4053(int i, int i_257_, int i_258_, int i_259_, Class365_Sub1_Sub4 class365_sub1_sub4, int i_260_) {
		try {
			...
			if (null != class326) {
				class365_sub1_sub4.method4340(new Vector3f((float) ((i_257_ << positionHash * -1688804109) + (394962841 * this.anInt3546)), (float) i_259_, (float) ((i_258_ << -1688804109 * positionHash) + 394962841 * (this.anInt3546))));
				class326.aClass365_Sub1_Sub4_3462 = class365_sub1_sub4;
				int i_261_ = aClass_xaArray3521 == aClass_xaArray3517 ? 1 : 0;
				if (class365_sub1_sub4.method4399()) {
					if (class365_sub1_sub4.method4376()) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.h(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub3 method4054(int i, int i_262_, int i_263_) {
		try {
			Class326 class326 = gameSceneBase[i][i_262_][i_263_];
			if (null != class326) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.o(").append(')').toString());
		}
	}
	...
	public boolean method4055(Class_na class_na, int i, int i_265_, int i_266_, boolean[] bools, int i_267_) {
		try {
			boolean bool = false;
			if (aClass_xaArray3521 != aClass_xaArray3517) {
				int i_268_ = aClass_xaArray3519[i].method6340(i_265_, i_266_);
				int i_269_ = 0;
				for (/**/; i_269_ <= i; i_269_++) {
					FloorToolkit class_xa = aClass_xaArray3519[i_269_];
					if (null == class_xa) {
						if (i_267_ == 2008908432)
							throw new IllegalStateException();
					} else {
						int i_270_ = i_268_ - class_xa.method6340(i_265_, i_266_);
						if (bools != null) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.au(").append(')').toString());
		}
	}

	public void method4056(int i, FloorToolkit class_xa, byte i_271_) {
		try {
			aClass_xaArray3517[i] = class_xa;
		} catch (RuntimeException runtimeexception) {
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.u(").append(')').toString());
		}
	}
	...
	public void method4057(int i, int i_272_, int i_273_, Class365_Sub1_Sub2 class365_sub1_sub2, int i_274_) {
		try {
			...
			if (class326 != null) {
				...
				if (class365_sub1_sub2.method4399()) {
					if (class365_sub1_sub2.method4376()) {
			...
			throw ErrorReporter.generateReport(runtimeexception, new StringBuilder().append("nu.t(").append(')').toString());
		}
	}

	public Class365_Sub1_Sub2 method4058(int i, int i_276_, int i_277_) {
			Class326 class326 = gameSceneBase[i][i_276_][i_277_];
			if (class326 == null || class326.aClass365_Sub1_Sub2_3461 == null)
				return null;
			return class326.aClass365_Sub1_Sub2_3461;
	}

	public Class365_Sub1_Sub4 method4059(int i, int i_279_, int i_280_) {
			Class326 class326 = gameSceneBase[i][i_279_][i_280_];
			if (class326 == null)
				return null;
	...
	public int method4060(int i, int i_282_) {
			return (this.aByteArrayArray3526 != null ? this.aByteArrayArray3526[i][i_282_] & 0xff : 0);
	}

	static final void method4061(ScriptRuntime runtime) {
			runtime.integerStackOffset -= 1551802473;
			int i_284_ = (runtime.integerStack[681479919 * runtime.integerStackOffset]);
			int i_285_ = ((runtime.integerStack[runtime.integerStackOffset * 681479919 + 1]) << 1);
			int i_286_ = (runtime.integerStack[2 + runtime.integerStackOffset * 681479919]);
			int i_287_ = (runtime.integerStack[681479919 * runtime.integerStackOffset + 3]);
			int i_288_ = (runtime.integerStack[681479919 * runtime.integerStackOffset + 4]);
			int i_289_ = (runtime.integerStack[runtime.integerStackOffset * 681479919 + 5]);
			int i_290_ = (runtime.integerStack[681479919 * runtime.integerStackOffset + 6]);
			if (i_284_ >= 0 && i_284_ < 2 && null != GameClient.anIntArrayArrayArray8767[i_284_] && i_285_ >= 0 && i_285_ < GameClient.anIntArrayArrayArray8767[i_284_].length) {
				GameClient.anIntArrayArrayArray8767[i_284_][i_285_] = new int[] { (i_286_ >> 14 & 0x3fff) << 9, i_287_ << 2, (i_286_ & 0x3fff) << 9, i_290_ };
				GameClient.anIntArrayArrayArray8767[i_284_][1 + i_285_] = new int[] { (i_288_ >> 14 & 0x3fff) << 9, i_289_ << 2, (i_288_ & 0x3fff) << 9 };
			}
	}
